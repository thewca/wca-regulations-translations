...
- 2c) Os competidores se inscrevem fornecendo todos os dados exigidos pela equipe de organização (incluindo: nome, país, data de nascimento, gênero, informações de contato, eventos escolhidos).
    - 2c1) Um competidor não está elegível para competir sem uma inscrição completa, conforme determinado pela equipe de organização e pelo Delegado da WCA.
    - 2c2) Competidores recorrentes devem fornecer informações pessoais consistentes com o seu perfil da WCA. Se um competidor desejar mudar ou atualizar as suas informações pessoais entre competições (p. ex. uma mudança de país, nome ou gênero), eles devem contactar o (Time de Resultados da WCA [results@worldcubeassociation.org] diretamente ou através de um Delegado da WCA.
...
- 2e) Competidores devem representar um país do qual tenham cidadania. O Delegado da WCA deve verificar a cidadania através de meios como documentos ou fotos de documentos (p. ex. passaporte) na sua primeira competição. Se um competidor é descoberto como inapto para representar o país pelo qual se registrou, o competidor pode ser desqualificado retroativamente e/ou suspenso, a critério do Quadro de Diretores da WCA.
    ...
    - 2e2) Competidores podem mudar o seu país a qualquer momento entre competições (ver Regra 2c2)[regulations:regulation:2c2], contanto que isso aconteça pelo menos um ano depois da mudança anterior.
        - 2e2a) Exceção: se o competidor perder a cidadania do país que representou anteriormente, eles podem mudar o seu país antes ou durante a sua próxima competição.
        - 2e2b) Exceção: Se o competidor tiver obtido uma nova cidadania dentro de um ano de uma ano civil, ele pode mudar o seu país para a sua nova cidadania antes ou durante a sua próxima competição.
...
- 2g) Os competidores precisam permanecer quietos quando estiverem dentro da área designada de competição. É permitido falar, mas o barulho tem que ser mantido em um nível razoável, e distante dos competidores que estiverem competindo ativamente.
    - 2g3) Competidores em um grupo em progresso não devem se comunicar com outros competidores no grupo sobre os estados dos embaralhamentos do grupo, a menos que todos os competidores não estejam elegíveis a nenhuma tentativa no grupo. Penalidade: desqualificação do(s) competidor(es) do evento, a critério do Delegado da WCA. Exceção: Para 3x3x3 em Menos Movimentos e 3x3x3 Multi-Vendado, competidores que tenham terminado as suas tentativas podem compartilhar e discutir a(s) sequência(s) de embaralhamento com outros competidores no grupo que tiverem terminado a sua tentativa ou tenham recusado a tentativa.
        - 2g3a) Para rodadas nas quais os resultados estiverem sendo postados ao vivo, a equipe de organização pode reforçar que os competidores não são permitidos a ver os resultados postados de seu grupo, a menos que tenham completado todas as suas tentativas.
- 2h) Competidores devem estar apropriadamente vestidos no local da competição. A critério do Delegado da WCA, competidores podem ser desqualificados do campeonato por uso de vestimentas inadequadas.
- 2i) Enquanto estiverem inspecionando ou resolvendo, competidores não devem usar eletrônicos (p. ex. celulares, fones de ouvido, luzes adicionais) além do timer Stackmat ou cronômetro. Penalidade: desqualificação da tentativa (DNF). Qualquer item que tiver qualquer componente eletrônico é considerado um eletrônico.
...
- 11f) Decisões sobre um incidente podem ser apoiadas por evidências em vídeo, fotográficas ou de áudio, a critério do Delegado da WCA.
    - 11f1) Para vídeos e formas semelhantes de evidência gravada, é recomendável que sejam analisados em tempo real. Exceção: a análise em câmera lenta ou quadro a quadro pode ser usada nas seguintes circunstâncias:
        ...
        - 11f1d) Para apoiar a remoção de qualquer pena originalmente aplicada pelo juiz ou Delegado da WCA, ver Regra 11f2a.
    - 11f2) Evidências obtidas por meio de análise em câmera lenta ou quadro a quadro podem ser usadas apenas para apoiar as seguintes decisões:
        - 11f2a) A remoção de qualquer pena originalmente aplicada pelo juiz ou Delegado da WCA.
        - 11f2b) A aplicação de uma pena de acordo com a Regra A3c1, Regra A4b ou Regra A4b1.
...
- A4) Iniciando a resolução:
    ...
    - A4d) Se o timer Stackmat estiver sendo usado, é recomendável que o competidor mantenha suas mãos no timer até que ele veja uma luz verde no timer. O timer é iniciado quando o competidor remove sua(s) mão(s) do timer. O competidor começa a resolução quando o timer for iniciado.
...
- A6) Finalizando a resolução:
    ...
    - A6d) O competidor deve parar o timer Stackmat usando ambas as mãos, colocadas planas sobre os sensores e com as palmas para baixo. Pena: pena de tempo (+2 segundos).
...
- A7) Registrando resultados:
    - A7a) O juiz diz ao competidor o resultado.
        - A7a1) É recomendável que o juiz indique ao competidor que o quebra-cabeça está resolvido, ou que uma penalidade será aplicada.
    - A7b) O juiz anota o resultado em uma súmula e assina ao lado do resultado para atestar que o resultado está correto, completo, formatado corretamente e legível. É recomendável que a assinatura do juiz seja consistente durante toda a competição e que, através dela, seja possível identificar o juiz.
        - A7b1) Se alguma pena for aplicada, o juiz anota o resultado original mostrado no timer, juntamente com quaisquer penas. É recomendável que formato seja "X + T + Y = F", em que X representa a soma das penas de tempo antes/no início da resolução, T representa o tempo mostrado no timer, Y representa a soma das  de tempo durante/depois da resolução e F representa o resultado final (p. ex. 2 + 17,65 + 2 = 21,65). Se X e/ou Y forem 0, os termos 0 são omitidos (p. ex. 17,65 + 2 = 19,65).
    - A7c) O competidor deve verificar o resultado registrado e assinar (ou colocar sua inicial) a súmula para reconhecer que o resultado está correto, completo, devidamente formatado e claramente legível. Isso conclui a tentativa.
...
- E2) Procedimento para 3x3x3 em Menos Movimentos:
    ...
    - E2b) Todos os competidores têm um limite total de tempo de 60 minutos para encontrar uma solução.
        - E2b1) É recomendável que o juiz anuncie "5 MINUTOS RESTANTES" quanto o tempo atingir 55 minutos, e deve dizer "PAREM" quando o tempo atingir 60 minutos.
- E2c) Ao final dos 60 minutos, cada competidor deve entregar ao juiz uma única folha de papel com uma solução escrita e informações para identificar a tentativa. A solução do competidor é considerada correta se, começando com um quebra-cabeça resolvido e aplicando a sequência de embaralhamento seguida pela solução, o quebra-cabeça terminar resolvido. Pena para uma solução incorreta: desqualificação da tentativa (DNF).
    - E2c1) Informações para identificar a tentativa incluem: o nome do competidor, ID da WCA ou ID do competidor naquela competição (pelo menos uma, opcionalmente múltiplas), e opcionalmente o nome da competição, rodada ou número da tentativa. Pena para uma solução entregue sem informações para identificar a tentativa: desqualificação da tentativa (DNF). As informações para identificar a tentativa podem ser adicionadas pelo competidor após a entrega da tentativa, mas antes do final da competição, a critério do Delegado da WCA e sob supervisão direta de um juiz. O competidor não deve escrever nada após o limite de tempo sem a supervisão do juiz e não deve fazer alterações na solução. Pena: desqualificação da tentativa (DNF).
    - E2c2) A solução deve ser uma sequência de movimentos não ambígua, com cada movimento escrito em ordem sequencial. Pena para uma solução ambígua: desqualificação da tentativa (DNF).
    - E2c3) É recomendável que o competidor deixe claro quais movimentos fazem parte da solução, apagando ou rabiscando qualquer movimento que queira excluir ou desenhando um único contorno ao redor da solução.
    - E2c4) Somente números, letras e apóstrofos são considerados como parte da solução do competidor. Outros símbolos são desconsiderados. A solução restante deve usar apenas movimentos exatamente definidos como notação para o Cubo 3x3x3 na [Regra 12a](regulations:regulation:12a). Pena: desqualificação da tentativa (DNF).
    - E2c6) Caso um competidor utilize capitalização incorreta para um movimento definido na [Regra 12a](regulations:regulation:12a), é recomendável que  ele seja interpretado como se estivesse com a capitalização correta e aceito como notação válida.
...
- E5) O competidor não deve se comunicar com ninguém além do Delegado da WCA ou do juiz. É recomendável que esta comunicação seja sobre Regras da WCA e o competidor não deve receber assistência em sua solução. Penalidade: desqualificação da tentativa (DNF).
