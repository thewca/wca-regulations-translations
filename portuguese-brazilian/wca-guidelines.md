...
- A2a3+) [LEMBRETE] Não é recomendável que competidores sejam permitidos de verem as sequências de embaralhamento de seu próprio grupo mesmo após completarem todas as tentativas, a não ser que permissão seja dada pelo Delegado da WCA (ver [Orientação 4b2+](guidelines:guideline:4b2+))
