...
- 2c+) [TILLÄGG] Tävlande som tävlar för första gången bör registrera sig med sitt juridiska namn. De får registrera sig med ett rimligt smeknamn, enligt WCA-Delegatens bedömning.
- 2c2+) [FÖRTYDLIGANDE] En WCA-profil är samlingen av data relaterad till en tävlande och inkluderar hens personliga information (namn, nationalitet, kön, och födelsedatum) samt alla hens resultat i officiella WCA-tävlingar.
...
- 2e+) [FÖRTYDLIGANDE] Om en tävlande har flera medborgarskap får hen välja vilket land hen ska representera vid sin första tävling.
...
- 2i1c+) [FÖRTYDLIGANDE] Elektroniska handvärmare får endast användas före eller efter ett försök. Icke-elektroniska handvärmare får användas när som helst under ett försök.
- 2i2a+) [TILLÄGG] En skärm på en kamera får vara synlig för den tävlande så länge den inte visar vad kameran filmar live.
...
- 5b5++) [EXEMPEL] Exempel på delar som är fysiskt lossnade, vilket resulterar i en "DNF": två mittbitar på en 3x3x3, två mittbitar på en stor kub, en kantbit på en 3x3x3, en kantbit på en 4x4x4 ("wing"), vilken kombination som helst av två bitar som har färgade delar.
- 5b5+++) [EXEMPEL] Exempel på delar som är fysiskt fästa men inte helt placerade, vilket resulterar i ett löst tillstånd: en mittbit på en 5x5x5 som är vriden på sin plats.
- 5b5++++) [EXEMPEL] Exempel på delar som är fysiskt fästa men inte helt placerade, vilket resulterar i en "DNF": en kantbit på en 3x3x3 som delvis sticker ut.
...
- 11e+) [FÖRTYDLIGANDE] Eftersom ett begärande av ett extra försök inte är garanterat att lyckas, får den tävlande välja att hålla timern igång medan hen begär ett extra försök och återuppta försöket när det är lämpligt.
...
- A7g+) [EXEMPEL] Exempel på incidenter som kan ge en ny tävlande ett extra försök: att inte vänta på grönt ljus, felaktig start eller stopp av timern, gå över inspektionstiden på grund av missförstånd om hur man startar en lösning, eller andra tävlingsprodecursrelaterade tidsstraff.
- A7g++) [FÖRTYDLIGANDE] Enskilda straff får inte tas bort från nya tävlande. Ett fullständigt extra försök måste beviljas.
- A7g+++) [REKOMMENDATION] WCA-Delegaten bör göra ett noggrannare övervägande när hen ger mer än ett extra försök till samma nya tävlande. Om mer än ett extra försök beviljas bör det vara för en annan incident.



## <article-B><blindfolded><blindfoldedsolving> Artikel B: Blindlösning

- B1+) [PÅMINNELSE] Den tävlande måste använda ett pussel utan texturer, markeringar, eller något annat som skiljer liknande delar från varandra (se [Regel 3k](regulations:regulation:3k)). Detta bör ägnas särskild uppmärksamhet vid Blindlösning.
