...
- 2c) Tävlande registrerar sig genom att tillhandahålla all information som krävs av arrangörsteamet (inklusive: namn, land, födelsedatum, kön, kontaktinformation, valda grenar).
    ...
    - 2c2) Återkommande tävlande måste tillhandahålla personlig information som överensstämmer med deras WCA-profil. Om en tävlande vill ändra eller uppdatera sin personliga information mellan tävlingar (t.ex. en ändring av nationalitet, namn eller kön) måste de [kontakta WCA Results Team](https://www.worldcubeassociation.org/contact/website).
- 2d) En tävlandes namn, land, kön och tävlingsresultat anses vara offentlig information. All annan personlig information betraktas som konfidentiell och får inte lämnas ut till externa organisationer/personer utan medgivande från den tävlande.
- 2e) Tävlande måste representera ett land där de har medborgarskap. WCA-Delegaten bör verifiera medborgarskapet med hjälp av dokument (t.ex. ett pass) vid den tävlandes första tävling. Om en tävlande inte är kvalificerad att representera det land under vilket hen har registrerat sig, kan den tävlande diskvalificeras retroaktivt och/eller stängas av, enligt WCA-Styrelsens bedömning.
    - 2e1) De tillgängliga länderna definieras av [WCA:s lista över erkända länder](https://www.worldcubeassociation.org/regulations/countries/).
    - 2e2) Tävlande med uppdateringar av sitt medborgarskap får ändra sitt land före eller vid deras första tävling under ett kalenderår. Undantag: om tävlande förlorar medborgarskap i det land som de tidigare representerade, måste de ändra vilket land de representerar före eller vid sin nästa tävling (se [Regel 2c2](regulations:regulation:2c2)).
...
- 2k) Enligt WCA-Delegatens bedömning får en tävlande diskvalificeras från grenar (en gren, flera grenar, eller alla grenar) om den tävlande:
    ...
    - 2k6) Inte uppfyller grenens krav (t.ex. att inte veta hur man löser pusslet). En tävlande får inte tävla med förväntningen av ett DNF-resultat eller ett avsiktligt dåligt resultat.
...
- 2n) Tävlande får muntligt bestrida ett beslut till WCA-Delegaten.
    - 2n1) Bestridanden är endast tillåtna under tävlingen, inom 30 minuter efter det att den händelsen dispyten gäller inträffade och innan början av följande omgångar av den aktuella grenen.
...
- 2s) Tävlande med funktionsvariationer som kan hindra dem från att följa en eller flera WCA-Regler får begära särskilda anpassningar från WCA-Delegaten. Tävlande som begär sådana anpassningar bör kontakta arrangörsteamet och WCA-Delegaten minst två veckor före tävlingen.
...
- 3h) Ändringar som ändrar det grundläggande konceptet för ett pussel är inte tillåtna. Modifierade versioner av pussel är endast tillåtna om modifieringen inte gör någon ytterligare information tillgänglig för den tävlande (t.ex. orientering eller identitet av bitar), jämfört med en omodifierad version av samma pussel.
    ...
    - 3h4) För Clock är anpassade "inserts" (samma form och storlek som de traditionella pappersinsatserna) tillåtna, enligt WCA-Delegatens bedömning. Insatserna måste ha en tydlig indikation av klockan 12 som matchar originalinsatserna.
...
- 3l) Ett pussel får ha en logotyp på en färgad del. Om den har det måste den högst ha en färgad del med en logotyp. Undantag: För blind-grenar får pussel inte ha någon logotyp.
...
- 4g) Efter att ett pussel blandats måste blandaren kontrollera att pusslet är blandat korrekt. Om pusslets tillstånd är fel måste blandaren korrigera det (t.ex. genom att lösa pusslet och tillämpa blandningssekvensen igen).
    - 4g1) Undantag: För 6x6x6, 7x7x7, och Megaminx är det inte nödvändigt att korrigera pusslets tillstånd, enligt WCA-Delegatens bedömning.
...
- 9f) Resultaten för en omgång mäts enligt följande:
    - 9f1) Alla försök med resultat under 10 minuter, förutom 3x3x3 Multi-Blind, mäts och trunkeras till närmaste hundradels sekund. Alla snitt under 10 minuter mäts och avrundas till närmaste hundradels sekund.
...
- 9l) Varje omgång måste slutföras innan någon efterföljande omgång av samma gren får starta.
...
- 11e) Om en incident inträffar under ett försök får WCA-Delegaten bevilja en tävlande ett extra försök som ersätter försöket under vilket incidenten inträffade. Den tävlande måste begära ett extra försök muntligt eller skriftligt till domaren och WCA-Delegaten vid tidpunkten för incidenten, innan hen avslutar det ursprungliga försöket, för att vara berättigad till ett extra försök. Ett begärande garanterar inte den tävlande ett extra försök.
...
- A1) Snabblösningsförsök måste följa följande procedurer ([Regel Y7](regulations:regulation:Y7) har prioritet över delar av procedurerna).
    - A1a) Arrangörsteamet måste tillämpa exakt en typ av tidsgräns (tidsgräns per försök eller kumulativ tidsgräns) för varje omgång.
...
- A3) Inspektion:
    ...
    - A3c) Den tävlande får plocka upp pusslet under inspektionen.
        - A3c1) Den tävlande får inte utföra några drag under inspektion. Straff: diskvalificering av försöket (DNF).
        - A3c2) Om pusslets delar inte är helt justerade får den tävlande justera sidorna, så länge feljusteringar ligger inom gränserna för [Regel 10f](regulations:regulation:10f).
    ...
    - A3d) I slutet av inspektionen placerar den tävlande pusslet på mattan, i vilken orientering som helst. Straff för att placera det utanför mattan: tidsstraff (+2 sekunder).
        - A3d2) När 8 sekunder av inspektion har gått, säger domaren "8 SECONDS".
        - A3d3) När 12 sekunder av inspektion har gått, säger domaren "12 SECONDS".
- A4) Starta lösningen:
    - A4b) Den tävlande använder fingrarna för att röra vid de upphöjda sensorytorna på timern. Den tävlandes handflator måste vara vända nedåt och placeras på den sida av timern som är närmast sig. Straff: tidsstraff (+2 sekunder).
        - A4b1) Den tävlande får inte ha någon fysisk kontakt med pusslet när lösningen påbörjas. Straff: tidsstraff (+2 sekunder).
    - A4d) Om en Stackmat-timer används bör den tävlande hålla händerna på timern tills hen ser ett grönt ljus på timern. Den tävlande startar lösningen genom att ta bort händerna från timern (och därmed starta timern).
...
- A5) Under lösningen:
    - A5a) Under inspektion eller lösning av pusslet får den tävlande inte kommunicera med någon annan än domaren eller WCA-Delegaten. Straff: diskvalificering av försöket (DNF).
...
- A6) Avsluta lösningen:
    - A6a) Den tävlande släpper pusslet innan hen avslutar lösningen, och avslutar lösningen genom att stoppa timern. Om ett stoppur används stoppar domaren stoppuret så snart den tävlande gör detta.
        - A6a1) När ett stoppur används som den enda tidtagningen avslutar den tävlande lösningen genom att släppa pusslet och meddela domaren att hen har avslutat lösningen. Domaren stoppar stoppuret så snart den tävlande gör detta.
        - A6a2) När ett stoppur används som den enda tidtagningen består den tävlandes standardsignal av att släppa pusslet från sina händer och placera händerna på ytan, med handflatorna nedåt. Den tävlande och domaren får komma överens om en annan lämplig signal innan försöket börjar.
    ...
    - A6g) Domaren avgör om pusslet är löst. Domaren får inte röra pusslet innan hen har bestämt sig för om hen ska tilldela ett straff för feljustering. Undantag: För Clock behöver domaren vanligtvis plocka upp pusslet för att verifiera båda sidorna.
...
- A7) Antecknande av resultat:
    - A7a) Domaren berättar resultatet för den tävlande.
        - A7a1) Om domaren bedömer att pusslet är löst säger hen "OKAY".
        - A7a2) Om domaren tilldelar några straff säger hen "PENALTY".
        - A7a3) Om resultatet är DNF säger domaren "DNF".
    - A7b) Domaren skriver resultatet på ett resultatkort och signerar bredvid resultatet för att bekräfta att resultatet är korrekt, komplett, korrekt formaterat, och tydligt läsbart.
        - A7b1) Om straff tilldelas skriver domaren den ursprungliga tiden som visas på timern, tillsammans med eventuella straff. Formatet ska vara "X + T + Y = F", där X är summan av tidsstraff före/under starten av lösningen, T är tiden som visas på timern, Y är summan av tidsstraff under/efter lösningen, och F är slutresultatet (t.ex. 2 + 17,65 + 2 = 21,65). Om X och/eller Y är 0 utelämnas 0-termerna (t.ex. 17,65 + 2 = 19,65).
    - A7c) Den tävlande måste kontrollera det antecknade resultatet och signera resultatkortet för att bekräfta att resultatet är korrekt, komplett, korrekt formaterat och tydligt läsbart. Detta avslutar försöket.
        ...
        - A7c2) Om den tävlande signerar (eller på annat sätt markerar) ett försök innan det har påbörjats, förbrukar hen försöket och resultatet bedöms som DNS.
        ...
        - A7c5) Saknade signaturer som upptäcks före tävlingens slut får läggas till av domaren och/eller den tävlande, enligt WCA-Delegatens bedömning.
    - A7f) När en tävlandes resultatkort för en omgång är komplett levererar domaren resultatkortet till resultatregistreraren.
    - A7g) Enligt WCA-Delegatens bedömning får en incident eller ett straff som orsakats av en ny tävlandes oerfarenhet ersättas med ett extra försök.
...
- B1) Standardprocedurerna för snabblösning följs som beskrivet i [Artikel A](regulations:article:A) (Snabblösning). Ytterligare regler som ersätter motsvarande procedurer i [Artikel A](regulations:article:A) finns beskrivna nedan. ([Regel Y7](regulations:regulation:Y7) har prioritet över delar av procedurerna).
    - B1a) Det finns ingen inspektionsfas.
...
- B2) Starta försöket:
    ...
    - B2b) Den tävlande använder fingrarna för att röra vid de upphöjda sensorytorna på timern. Den tävlandes handflator måste vara vända nedåt och placeras på den sida av timern som är närmast sig. Straff: tidsstraff (+2 sekunder).
    - B2c) Den tävlande får inte ha någon fysisk kontakt med pusslet eller dess cube cover när hen startar försöket. Straff: tidsstraff (+2 sekunder).
...
- B3) Memoreringsfas:
    ...
    - B3c) Den tävlande får inte göra några drag på pusslet under memoreringsfasen. Straff: diskvalificering av försöket (DNF).
...
- B5) Avsluta lösningen:
    ...
    - B5b) När ett stoppur används avslutar den tävlande lösningen genom att lägga tillbaka pusslet på ytan och meddela domaren att hen stoppar lösningen. I det ögonblicket stoppar domaren timern.
...
- E3) Den tävlande får använda följande objekt under försöket. Straff för att använda otillåtna objekt: diskvalificering av försöket (DNF).
    - E3a) Papper (tillhandahålls av domaren) och pennor eller liknande (tillhandahålls av domaren, eller den tävlande själv om så önskas).
    - E3b) 3x3x3-kuber (högst 3, tillhandahålls av den tävlande), som beskrivet i [Artikel 3](regulations:article:3).
...
- F2) Domaren placerar det blandade pusslet på mattan i stående position.
    - F2a) Arrangörsteamet får kräva användandet av ett stativ för pusslet för att förhindra att det ramlar innan försöket börjar. Om sådana stativ används bör arrangörsteamet meddela detta innan omgången startar.
        - F2a1) Domaren måste ta bort stativet från mattan omedelbart efter att den tävlande har tagit bort pusslet från det.
- F3) I slutet av inspektionsfasen placerar den tävlande pusslet i stående position. Straff: diskvalificering av försöket (DNF).
    - F3a) Den tävlande får inte ändra positionerna på några pins från sina blandade positioner innan lösningen påbörjas. Straff: diskvalificering av försöket (DNF).


## <article-H><multiple-blindfolded><multipleblindfoldedsolving> Artikel H: Multi-Blind

- H1) Standardprocedurerna för blindlösning följs som beskrivet i [Artikel B](regulations:article:B) (Blindlösning). Ytterligare regler som ersätter motsvarande procedurer i [Artikel B](regulations:article:B) finns beskrivna nedan. ([Regel Y7](regulations:regulation:Y7) har prioritet över delar av procedurerna).
...
## <article-Y><temporary-regulations><temporaryregulations> Artikel Y: Tillfälliga Regler

- Y1) Ytterligare regler som har prioritet över alla andra regler beskrivs nedan. Dessa regler är avsedda att komplettera WCA:s [Competition Safety Policy](https://www.worldcubeassociation.org/documents/policies/external/Competition%20Safety.pdf).
- Y2) Definitioner:
    - Y2a) Deltagare: Alla som deltar i en WCA-tävling, inklusive tävlande, funktionärer och gäster.
    - Y2b) Fasta sittplatser: En tävlingsmetod där en tävlande gör alla sina försök i en omgång vid en och samma lösningsstation.
- Y3) Om WCA-Delegaten anser det nödvändigt det och tydligt meddelas före tävlingen, får förutom vad som krävs i [Regel 2a](regulations:regulation:2a), en deltagare krävas att uppfylla ett eller flera av följande krav:
    - Y3a) Bära ett munskydd i tävlingslokalen.
    - Y3b) Inte ha kommit i kontakt med en person med COVID-19 minst 14 dagar före tävlingen.
    - Y3c) Inte ha COVID-19 eller att känna symptom av COVID-19 (enligt av [Världshälsoorganisationen](https://www.who.int/)) minst 14 dagar före tävlingen.
    - Y3d) Följa andra rimliga säkerhetsåtgärder som godkänts av Världshälsoorganisationen eller av lokala myndigheter.
- Y4) Alla tävlande och funktionärer bör ta med en egen penna till tävlingen.
- Y5) Domare får ta med sig ett eget stoppur eller telefon för tidtagning av inspektion, vilket bör kontrolleras av WCA-Delegaten.
- Y6) Miljö:
    - Y6a) Om det anses nödvändigt av WCA-Delegaten behöver tävlingen inte ha ett väntområde.
    - Y6b) Tävlande bör undvika från att röra vid ytan på lösningsstationen när de inte gör ett officiellt försök.
- Y7) Tävlingsprocedurer som har prioritet över [Artikel A](regulations:article:A), [B](regulations:article:B), och [H](regulations:article:H) beskrivs nedan. Dessa procedurer gäller inte [Artikel E](regulations:article:E), Minst Antal Drag.
    - Y7a) Tävlingar bör använda fasta sittplatser (se [Regel Y2b](regulations:regulation:Y2b)).
    - Y7b) Domaren bör alltid undvika att röra pusslet. Undantag: för Clock bör domaren plocka upp pusslet för att verifiera att båda sidorna är lösta.
    - Y7c) Blandning:
        - Y7c1) När den tävlande kallas till en omgång, efter att ha desinficerat sina pussel, lämnas pusslet in, i sitt lösta tillstånd, till blandaren. Den tävlande väntar sedan på sin tilldelade lösningsstation.
    - Y7d) Inspektion:
        - Y7d1) Domaren ber den tävlande att förbereda timern genom att sätta på den och nollställa den vid behov. Den tävlande sätter sedan på timern och nollställer den vid behov. Domaren bör alltid undvika att röra vid timern.
    - Y7e) Anteckna resultat:
        - Y7e2) Den tävlande bör inte röra resultatkortet.
    - Y7f) Efter att ha avslutat försöket, om det finns fler försök kvar att genomföra, måste den tävlande placera pusslet i dess cube cover.
