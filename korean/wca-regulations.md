...
- 1f) 각 종목은 스크램블러가 반드시 한 명 이상 있어야 한다. 예외: 최소회전
    ...
    - 1f2) 운영진의 필요 시 역량이 있는 선수들은 스크램블이 가능해야 한다. 함당한 이유(예: 회전기호가 익숙하지 않음)가 있을 때만 요청에서 제외될 수 있다. 어길 시 벌칙: 대회로부터의 실격([규정 2k항](regulations:regulation:2k) 참조)
