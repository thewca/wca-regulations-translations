...
- 2c) Thí sinh đăng ký tham gia thi bằng cách cung cấp toàn bộ thông tin mà ban tổ chức yêu cầu (bao gồm: tên đầy đủ, quốc tịch, ngày sinh, giới tính, thông tin liên lạc, nội dung thi đấu).
    ...
    - 2c2) Các thí sinh đã tham gia thi trước đó phải cung cấp thông tin giống với thông tin trên hồ sơ WCA. Nếu thí sinh muốn cập nhật thông tin (VD: đổi quốc tịch, tên, giới tính), thi sinh phải liên hệ trực tiếp [Đội ngũ Kết quả WCA (WRT)](https://www.worldcubeassociation.org/contact?contactRecipient=wrt) hoặc liên hệ thông qua Delegate.
...
- 2i) Khi đang trong thời gian quan sát hoặc giải, thí sinh không được sử dụng thiết bị điện tử (VD: điện thoại di động, tai nghe, đèn đề bản) ngoài đồng hồ Stackmat và đồng hồ bấm giờ. Hình phạt: hủy kết quả lượt thi (DNF). Các thiết bị có bất kì linh kiện điện tử nào đều được coi là thiết bị điện tử.
    - 2i1) Thí sinh được sử dụng các vật hỗ trợ không có linh kiện điện tử nếu các thiết bị này không tạo lợi thế bất công, tùy theo quyết định của WCA Delegate, bao gồm:
        ...
        - 2i1b) Bịt tai chụp tai và nhét tai (không phải tai nghe điện tử).
...
- 3d) Khối hình phải có các bộ phận (viên) có màu cấu tạo nên hệ màu của khối hình, và phải là một và chỉ một trong những loại bộ phận sau: sticker có màu, tấm nhựa màu (tile), nhựa màu, hoặc các loại màu được in lên hoặc sơn lên. Các bộ phận có màu phải có cùng chất liệu.
    - 3d1) Các thí sinh có khiếm khuyết về thị lực (có giấy tờ chứng minh) được hưởng các ngoại lệ sau:
        - 3d1a) Các thí sinh khiếm thị được phép sử dụng khổi hình có kết cấu mỗi mặt khác nhau. Mỗi mặt nên có một màu khác nhau, để hỗ trợ việc trọng tài giám sát và tráo đề.
...
- 4g) Sau khi tráo khối hình xong, người tráo đề phải xác nhận rằng khối hình được tráo đúng theo công thức. Nếu sai, người tráo đề phải sửa lại khối hình (bằng cách giải khối hình và tráo lại từ đầu).
    ...
    - 4g2) Đối với Giải Bịt mắt nhiều 3x3x3, sau khi tráo hết toàn bộ khối hình, người tráo đề phải đảm bảo không bị lặp không thức tráo.
...
- 9f) Kết quả của các vòng thi được tính như sau:
    ...
    - 9f2) Các kết quả tính giờ trên 10 phút và phần tính giờ của kết quả Giải Bịt mắt nhiều 3x3x3 được ghi lại và lược bỏ đến phần đơn vị của giây. Các kết quả trung bình trên 10 phút được ghi lại và là tròn đến giây gần nhất (VD: X.49 thành X, X.50 thành X+1).
...
- 10e) Khối hình được coi là đã giải xong nếu toàn bộ các bộ phận có màu ở đúng vị trí và thẳng hàng trong các giới hạn dưới đây:
    - 10e1) Với mỗi hai bộ phận liền kề (VD: hai tầng song song, liền nhaeu của khối lập phương) bị lệch nhiều hơn mức quy định tại giới hạn được quy định tại [Quy định 10f](regulations:regulation:10f), khối hình được coi là cần thêm một bước nữa để giải (xem "Hệ đo Bước Tầng ngoài" tại [Mục 12](regulations:article:12)).
...
- 10h) Các khối hình không được liệt kê trong mục này được xét trạng thái giải theo quy ước thông thường của khối hình.
    - 10h1) Trạng thái giải của Clock là khi tất cả 18 mặt đồng hồ con đều chỉ hướng 12h.
        - 10h1a) Các mặt đồng hồ con không chỉ đúng thẳng vào mốc giờ được coi là đang chỉ vào mốc giờ gần nhất.
...
- 11i) Nếu phát hiện khối hình của thí sinh bị tráo sai, các quy định sau đây được áp dụng:
    - 11i1) Trong các trường hợp sau đây, bắt buộc phải sử dụng lượt thi bổ sung để thay thế lượt thi bị ảnh hưởng. Nếu thí sinh không thi lượt bổ sung, lượt giải bị tính là DNS:
        ...
        - 11i1e) Ngoại lệ: Đối với nội dung Khối 5x5x5, Khối 6x6x6, Khối 7x7x7, Megaminx, và Giải Bịt mắt Nhiều 3x3x3, không cần thiết thay thể kết quả bằng lượt thi bổ sung cho các trường hợp trên.
...
- A3) Quan sát:
    ...
    - A3d) Khi đã quan sát xong, thí sinh đặt khối hình lên thảm kê, hướng theo bất kì hướng nào. Khối hình phải được đặt hoàn toàn trên thảm, và không được một phần hoặc hoàn toàn đặt bên trên đồng hồ Stackmat. Hình phạt: phạt cộng thời gian (+2 giây).
...
- A6) Kết thúc quá trình giải:
    - A6a) Thí sinh thả tay khỏi khối hình trước khi kết thúc quá trình giải, và kết thúc quá trình giải bằng cách dừng đồng hồ. Nếu sử dụng đồng hồ bấm giờ, trọng tài dừng đồng hồ ngay khi thí sinh làm những hành động trên.
        - A6a1) Nếu trọng tài không có mặt để dừng đồng hồ bấm giờ nếu có sử dụng, thí sinh được phép dự dừng đồng hồ bấm giờ.
...
- A7) Ghi kết quả:
    ...
    - A7b) Trọng tài ghi kết quả vào phiếu điểm và ký tên bên cạnh để xác nhận kết quả được ghi đúng, đầy đủ, đúng định dạng và rõ ràng. Chữ ký của trọng tài nên giữ nguyên xuyên suốt giải đấu và mang tính chất nhận dạng trọng tài.
    ...
    - A7c) Thí sinh phải kiểm tra kĩ kết quả được ghi lại, và ký tên để xác nhận kết quả được ghi đúng, đầy đủ, đúng định dạng và rõ ràng.
        - A7c1) Nếu trọng tài hoặc thí sinh từ chối công nhận kết quả và ký xác nhận vào phiếu điểm, WCA Delegate phải giải quyết khiếu nại.
        - A7c2) Nếu thí sinh cố ý ký tên (hoặc đánh dấu) xác nhận lượt thi khi chưa bắt đầu, lượt thi đó coi như bỏ và kết quả là DNS. Ngoại lệ: Đối với Giải Bịt mắt nhiều 3x3x3, thí sinh được ghi số khối hình sẽ sử dụng trên phiếu điểm.
        - A7c3) Nếu thí sinh ký tên (hoặc đánh dấu) xác nhận lượt thi sau khi đã bắt đầu nhưng trước khi trọng tài ghi xong kết quả, kết quả lượt thi bị hủy (DNF).
        - A7c4) Thí sinh không nên ký xác nhận lượt thi trước khi trọng tài đã ghi xong kết quả và ký xác nhận. Thí sinh chịu trách nhiệm cuối cùng về việc đảm bảo cả thí sinh và trọng tài đã ký xác nhận lượt thi. Nếu lượt thi thiếu một hoặc cả hai chữ ký khi phiếu điểm đã đến tay người nhập liệu (xem [Quy định A7f](regulations:regulation:A7f)), kết quả của lượt thi đó bị hủy (DNF).
        - A7c5) Nếu phát hiện các lượt thi thiếu chữ ký trước khi giải đấu kết thúc (xem [Quy định 9u](regulations:regulation:9u)), trọng tài và/hoặc thí sinh có thể ký bổ sung, tùy theo quyết định của WCA Delegate.
        - A7c6) Chữ ký của thí sinh nên giữ nguyên xuyên suốt giải đấu và mang tính chất nhận dạng thí sinh. Thí sinh không được cố ý ký tên sai cách. Hình phạt: hủy kết quả lượt thi, tùy theo quyết định của WCA Delegate.
        - A7c7) Thí sinh không nên viết vào phiếu điểm ở ngoài các ô để ký tên.
        - A7c8) Nếu phiếu điểm thiếu chữ ký do thí sinh thiếu kinh nghiệm, chữ ký của thể được bổ sung vào bất kỳ thời điểm nào, tùy theo quyết định của WCA Delegate. Nếu thí sinh hoặc trọng tài không thể tận tay ký xác nhận phiếu điểm, lời xác nhận rằng kết quả chính xác có thể được coi là chữ ký hợp lệ, tùy theo quyết định của WCA Delegate.
...
- E2) Quy trình thi đấu của nội dung Giải Tối ưu 3x3x3:
    ...
    - E2c) Khi đã hết 60 phút, thí sinh phải nộp duy nhất một tờ giấy thi cho trọng tài, trong giấy thi có ghi công thức giải và thông tin nhận diện lượt thi. Công thức giải của thí sinh được tính là đúng nếu từ một khối hình được giải xong, sau khi áp dụng công thức tráo và công thức giải của thí sinh, ta được một khối hình đã giải xong. Hình phạt nếu công thức giải sai: hủy kết quả lượt thi (DNF).
        ...
        - E2c4) Chỉ các con số, chữ cái và dấu tích (') mới được coi là thuộc công thức giải của thí sinh. Các ký hiệu khác đều được lược bỏ. Công thức giải còn lại chỉ được phép sử dụng các ký hiệu bước được định nghĩa cho Khối 3x3x3 tại [Quy định 12a](regulations:regulation:12a). Hình phạt: hủy kết quả lượt thi (DNF).
        ...
        - E2c8) Thí sinh không được phép cố tình cản trở việc chấm bài bằng cách sử dụng các bước hoặc ký hiệu không được định nghĩa là ký hiệu bước hợp lệ cho Khối 3x3x3, viết hoa/thường sai, hoặc bằng bất kỳ cách nào khác. Hình phạt: hủy kết quả lượt thi (DNF), tùy theo quyết định của WCA Delegate.
...
- E6) Thí sinh được phép tham gia lượt thi Giải Tối ưu 3x3x3 đang diễn ra, tùy theo quyết định của WCA Delegate. Ngoại lệ: trong các trường hợp sau đây, thí sinh không được tham gia lượt thi đang diễn ra:
    - E6a) Thí sinh đã hoàn thành lượt thi từ trước đó (xem [Hướng dẫn E2b+](guidelines:guideline:E2b+)).
