...
- 2u) Участник должен присутствовать и быть готовым, когда его вызывают для участия в попытке. Наказание: дисквалификация с дисциплины.
    - 2u1) Исключение: если участник не присутствует перед индивидуально запланированной попыткой (например, попытка Сборки 3x3x3 на количество ходов, попытка 3x3x3 мульти-блайнд), то по решению делегата WCA участнику можно поставить DNS, как если бы он отказался от этой попытки.
...
- A6) Окончание сборки:
    ...
    - A6c) Участник должен полностью отпустить головоломку перед остановкой таймера. Штраф: дисквалификация попытки (DNF). Исключение: если участник не делал ходов и не выравнивал грани головоломки после остановки таймера и до того, как он отпустил головоломку, по решению судьи штраф заменяется на +2 секунды.
