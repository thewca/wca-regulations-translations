...
- A7) Запись результатов:
    ...
    - A7g) Если участник получает штраф (или с ним происходит иной инцидент) из-за своей неопытности, то его попытка может быть заменена на дополнительную по решению делегата WCA.
