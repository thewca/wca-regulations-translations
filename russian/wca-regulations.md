...
- 2g) Участники должны вести себя тихо, находясь в обозначенной зоне для соревнования. Разговаривать можно, но на разумном уровне громкости и на расстоянии от соревнующихся в данный момент участников.
    - 2g3) Участникам текущей группы запрещено обсуждать с другими участниками этой группы перемешанные состояния головоломок текущей группы, за исключением случаев, когда все задействованные в обсуждении участники не имеют права на дальнейшие попытки в этой группе. Наказание: дисквалификация участника(ов) с дисциплины на усмотрение делегата WCA. Исключение: для Сборки 3x3x3 на количество ходов участники, закончившие попытку, могут сообщить информацию о перемешанном состоянии тем, кто не участвует в данной попытке или окончил её.
...
- 2i) Во время инспекции или сборки участникам запрещено использовать электронное или аудио оборудование (например, телефоны, MP3 плееры, диктофоны, дополнительное освещение), кроме стакмата или секундомера. Штраф: дисквалификация попытки (DNF).
    ...
    - 2i2) Участники могут пользоваться камерами на усмотрение делегата WCA, но с ограничениями, применяемыми от начала попытки до момента остановки сборки. Наказание за нарушение ограничений: дисквалификация попытки (DNF).
        ...
        - 2i2b) Участник не должен использовать включённую камеру (например, носить её). Исключение: участник может носить камеру на голове, если она находится вне поля зрения участника и если он с ней не взаимодействует (помимо того, что носит).
...
- 2s) При некоторых обстоятельствах (например, ограниченных возможностях здоровья), не позволяющих выполнить одно или несколько Положений WCA, участники могут запросить у делегата WCA специальные условия. Участникам, запрашивающим такие условия, следует связаться с командой организаторов и делегатом WCA по крайней мере за две недели до соревнования.
    - 2s1) Участникам, чьи обстоятельства приводят к невозможности следовать стандартными процедурам соревнований, могут быть предоставлены специальные условия. Такие ситуации следует передавать на обсуждение Комитету Положений WCA перед какими-либо распоряжениями.
...
- 3h) Модификации, которые совершенствуют основную структуру головоломки, запрещены. Модифицированные версии головоломок разрешены только в том случае, если модификация не даёт дополнительной доступной информации участнику (например, ориентацию или идентификацию элементов головоломки) по сравнению с немодифицированной версией этой головоломки.
    - 3h1) «Скруглённые» головоломки разрешены.
    - 3h2) Головоломки, у которых цветной пластик виден изнутри (т.н. головоломки «из цветного пластика») разрешены. Это не включает в себя:
...
- 3j) Головоломки должны быть чистыми и не должны иметь никаких пометок, выступающих элементов, повреждений или других различий, которые значительно отличают элементы головоломки от других похожих элементов. Исключение: логотип (см. [Положение 3l](regulations:regulation:3l)).
...
- 3m) Разрешены головоломки и части головоломок любых фирм, если эти головоломки удовлетворяют Положениям WCA.
...
- 5a) Повреждения головоломок включают в себя: выпавшие части головоломки, элементы, развёрнутые на своём месте, и открученные винты/выпавшие крышки/отклеенные наклейки.
- 5b) Если во время попытки происходит повреждение головоломки, участник может либо устранить повреждение и продолжить попытку, либо завершить попытку.
    - 5b1) Если участник выбирает устранение повреждения головоломки, он обязан чинить только повреждённые части. При ремонте головоломки запрещено использовать любые инструменты и части других головоломок. Штраф: дисквалификация попытки (DNF).
    ...
    - 5b3) Разрешённые действия при ремонте:
        - 5b3a) Если какие-либо части головоломки выпали или сдвинулись со своего места, участник может вернуть их обратно.
    ...
    - 5b5) Если к концу сборки части головоломки отделены от неё или не находятся полностью на своём месте, то применяются следующие Положения:
        - 5b5a) Если неисправна одна или несколько частей без цветных сторон, то головоломка считается собранной.
        - 5b5b) Если неисправна одна часть с одной цветной стороной, то головоломка считается собранной.
        - 5b5c) Если неисправно более одной части с одной цветной стороной, то головоломка считается несобранной (DNF).
        - 5b5d) Если неисправна одна или несколько частей с более чем одной цветной стороной, то головоломка считается несобранной (DNF).
        ...
        - 5b5f) Если часть головоломки отделена от неё или не находится полностью на своём месте, то её итоговым положением считается ближайшее положение, которое эта часть могла бы принять в механизме головоломки при текущем её состоянии. Если итоговое положение влечёт за собой собранность этой части, то она не считается неисправной.
    - 5b6) Определение: часть - это один или несколько полностью соединённых компонентов головоломки, которые остаются соединёнными друг с другом и не перемещаются друг относительно друга во время совершения ходов (например, крышка центрального элемента 3x3x3, угол Пираминкса, угловой элемент 3x3x3 без одной детали, одна деталь углового элемента 3x3x3).
...
- 10d) Все части головоломки должны быть физически прикреплены к головоломке, полностью располагаясь на своих местах. Исключение: см. [Положение 5b5](regulations:regulation:5b5).
...
- A1) Попытки в скоростной сборке должны проходить по следующей процедуре:
    - A1a) Команда организаторов должна установить как минимум один из следующих видов лимитов по времени для сборок: лимит на каждую попытку и/или суммарный лимит. Лимит должен быть установлен для каждого раунда.
        ...
        - A1a4) Участник должен заканчивать сборки до того, как истечёт лимит по времени. Если время на таймере участника достигло лимита по времени, судья немедленно останавливает сборку и ставит DNF. Исключение: 3x3x3 мульти-блайнд (см. [Положение H1b1](regulations:regulation:H1b1)).
...
- A3) Инспекция:
    ...
    - A3b) Судья подготавливает таймер, при необходимости включая его и сбрасывая. Если используется модель стакмата Generation 5 Pro, судья должен удостовериться, что он переведён в режим «2-Pad mode». Также судья подготавливает секундомер для измерения инспекции.
        ...
        - A3b3) Когда прошло 8 секунд инспекции, судья говорит: «8 секунд».
        - A3b4) Когда прошло 12 секунд инспекции, судья говорит: «12 секунд».
...
- A5) Во время сборки:
    - A5a) Во время инспекции и сборки участнику нельзя общаться с кем-либо, кроме судьи или делегата WCA. Штраф: дисквалификация попытки (DNF). Исключение: если участник не получил преимущества от общения с кем-либо, кроме судьи или делегата WCA, можно оставить результат исходной попытки на усмотрение делегата WCA.
...
- A6) Окончание сборки:
    ...
    - A6g) Судья определяет, собрана ли головоломка. Если грани на головоломке не выровнены, судья не должен касаться головоломки до тех пор, пока он не определит её состояние.
...
- A7) Запись результатов:
    ...
    - A7c) Участник должен проверить записанный результат и подписать его (или поставить инициалы) на карточке, принимая, что результат верный, полный, правильно отформатирован и хорошо читаем. После этого попытка заканчивается.
        ...
        - A7c2) Если участник намеренно подписывает (или иным способом помечает) попытку до того, как он её начал, он теряет эту попытку, и её результат DNS.
...
- E3) Во время попытки участник может использовать только нижеперечисленные предметы. Штраф за использование посторонних предметов: дисквалификация попытки (DNF).
    - E3a) Бумага (предоставляется судьёй), бланк для записи решения (предоставляется судьёй), изображение перемешанного состояния для данной попытки (может находиться на бумаге или на бланке для записи решения) и ручки/карандаши или похожие письменные принадлежности (предоставляются судьёй или приносятся участником).
