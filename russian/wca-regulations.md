...
- 3l) Головоломки могут иметь логотип на наклейке/пластинке, максимум один.
    ...
    - 3l2) Логотип может быть рельефным, выгравированным или иметь два слоя наклеек. Исключение: для сборок вслепую логотип должен быть таким, чтобы его было невозможно нащупать (т.е., не должен быть рельефным, выгравированным или иметь два слоя наклеек).
...
- Z4) Команда организаторов может ограничить число участников в дисциплинах или на соревновании либо по принципу "Кто успел, тот и съел", либо основываясь на результатах квалификации или на рейтинге WCA к определённой, заранее объявленной дате.
