...
- 11g) Делегат WCA должен убедиться в наличии доступа к Положениям WCA и Дополнениям (например, в печатном или цифровом виде или через Интернет), к которым участники и официальные лица смогут обратиться в случае инцидентов.
...
- H1) Процедура такая же, как и в [статье B](regulations:article:B) (сборка вслепую). Ниже описаны дополнительные положения, которые замещают соответствующие положения в [статье B](regulations:article:B).
    ...
    - H1e) Если участник случайно сделал ход на одной или нескольких из головоломок во время фазы запоминания, то данные головоломки можно считать несобранными после окончания сборки (вместо того, чтобы сразу дисквалифицировать попытку), по усмотрению Делегата WCA.
