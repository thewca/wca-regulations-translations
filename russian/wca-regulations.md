...
- 9g) Комбинированный раунд состоит из двух частей попыток, при этом участникам разрешается участвовать во второй части, если они преодолели заранее определённый лимит в первой части.
    - 9g2) Лимит для прохода во вторую часть комбинированного раунда должен быть определён по результатам (проходят все участники с результатом, меньшим х) в первой части (см. [Положение 9f12](regulations:regulation:9f12)).
...
- A1) Попытки в скоростной сборке должны проходить по следующей процедуре:
    - A1a) Команда организаторов должна установить лимиты по времени для сборок и/или для раундов.
        ...
        - A1a2) Могут быть установлены суммарные лимиты (например, 20 минут на 3 сборки - см. [Положение A1a5](regulations:regulation:A1a5)). Если в какой-либо попытке участник получает DNF, то реальное время его сборки всё равно считается в суммарном лимите.
