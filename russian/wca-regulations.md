...
- 3h) Модификации, которые совершенствуют основную структуру головоломки, запрещены. Модифицированные версии головоломок разрешены только в том случае, если модификация не даёт дополнительной доступной информации участнику (например, ориентацию или идентификацию частей головоломки) по сравнению с немодифицированной версией этой головоломки.
...
- 5b) Если во время попытки происходит повреждение головоломки, участник может либо устранить повреждение и продолжить попытку, либо завершить попытку.
    ...
    - 5b3) Разрешённые действия при ремонте:
        - 5b3a) Если любая часть головоломки выпала или сдвинулась со своего места, участник может вернуть её обратно.
    ...
    - 5b6) Определение: элемент - это один или несколько полностью соединённых компонентов головоломки, которые остаются соединёнными друг с другом и не перемещаются друг относительно друга во время совершения ходов (например, крышка центрального элемента 3x3x3, угловой элемент 3x3x3 без одной части, одна часть углового элемента 3x3x3).
