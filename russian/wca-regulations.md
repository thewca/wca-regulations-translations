...
- 7f) Места для сборок:
    - 7f1) Определения:
        - 7f1a) Стакмат: таймер марки Speed Stacks Stackmat в комплекте с полноразмерным матом. Допустимые к использованию модели: Generation 3 Pro Timer, Generation 4 Pro Timer и/или Generation 5 Pro Timer.
