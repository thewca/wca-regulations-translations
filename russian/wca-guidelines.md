...
- 5b5++) [ПРИМЕР] Примеры выпавших элементов, в которых головоломка считается несобранной (DNF): две крышечки от центров в 3x3x3; два центра в больших кубах; ребро в 3x3x3; ребро в 4х4х4; любая комбинация элементов, на которых суммарно есть две или более цветных стороны.
...
- A7g+) [ПРИМЕР] Примеры инцидентов, за которые можно дать дополнительную попытку новому участнику: участник не дождался зелёной лампочки на таймере; неправильно запустил или остановил таймер; превысил допустимое время инспекции из-за непонимания, как начинать попытку; или другие процедурные штрафы.
