...
- 5b5f++) [ПРИМЕР] Элемент ребра в Кубике 4x4x4 ("винг"), повёрнутый на своём месте, считается собранным.
- 5b5f+++) [ПРИМЕР] Угловой элемент, повёрнутый на своём месте, считается находящимся в допустимом положении, однако такое положениё не влечёт его собранность.
