...
- 2i1b+) [УТОЧНЕНИЕ] Сюда также включены соответствующие устройства, которые отключены или чей провод отсоединен.
...
- 5b5+++) [ПРИМЕР] Пример элемента, который физически прикреплен, но не находится полностью на своём месте, а головоломка считается собранной: центр 5x5x5, повёрнутый на своём месте.
