...
- <label>[ПРИМЕР] Пример применения Положений.
...
- 7f1a+) [УТОЧНЕНИЕ] Полноразмерный мат должен иметь размеры как минимум 30 см (с левой до правой стороны) на 25 см (с передней до задней стороны).  A full-size mat should have minimum dimensions of 30cm (left to right) by 25cm (front to back).
...
- E2e+) [УТОЧНЕНИЕ] Участники не должны вывести решение из любой части скрамбла, и им не следует копировать существенную часть обратного скрамбла.
