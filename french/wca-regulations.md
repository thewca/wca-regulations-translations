...
### Traduction
La traduction de ce document a été réalisée par [Philippe Virouleau](mailto:philippe.44@gmail.com) et mise à jour en 2018 par [Jules Desjardin](mailto:oranjules@hotmail.fr), et s'appuie sur les précédents travaux de Guillaume Erbibou, Pierre Calendini, et Gilles Roux.
...
- 1c) Le Délégué WCA peut déléguer ses responsabilités aux autres membres de l'équipe organisatrice, mais est responsable de la manière dont celles ci sont assurées. Le Délégué WCA d'une compétition est en charge de :
    ...
    - 1c3) Envoyer les résultats de la compétition à l'équipe des résultats de la WCA, au plus tard une semaine après la fin de la compétition.
        ...
        - 1c3b) Toutes les séquences de mélanges doivent être annotées avec les épreuves, les tours, et les groupes pour lesquels elles ont été utilisées.
...
- 2e) Les compétiteurs doivent représenter un pays dont ils ont la nationalité. Le Délégué WCA devrait vérifier la nationalité représentée au moyen d'un document officiel (par exemple : carte d'identité) à leur première compétition. Si un compétiteur n'est pas capable de prouver la nationalité sous laquelle il s'est inscrit, ce compétiteur peut être disqualifié rétroactivement et/ou suspendu, à la discrétion du Bureau de la WCA.
    ...
    - 2e2) Les compétiteurs ayant plusieurs nationalités peuvent changer le pays qu'ils représentent, avant ou pendant leur première compétition d'une année civile donnée. Exception : si le compétiteur perd la nationalité du pays qu'il représentait, il doit changer le pays qu'il représente avant ou pendant sa prochaine compétition.
...
- 2g) Les compétiteurs doivent rester calmes à l'intérieur de l'espace de compétition. Les discussions sont autorisées, mais elles doivent être d'un volume sonore raisonnable, et ne pas se dérouler à proximité des personnes en train de concourir.
    - 2g3) Les compétiteurs dans la Zone des Compétiteurs ne doivent pas communiquer entre eux à propos des mélanges des casse-têtes du tour en cours. Pénalité : disqualification du compétiteur de l'épreuve en cours, à la discrétion du Délégué WCA.
...
- 3k) Les casse-têtes devraient être approuvés par le Délégué WCA avant leurs utilisation en compétition.
    - 3k1) Si, au cours d'un tour, un casse-tête est déclaré non-autorisé, le compétiteur doit soumettre un autre casse-tête.
    - 3k2) Pénalité pour un essai réalisé avec un casse-tête non-autorisé : disqualification de l'essai (DNF). Exception : si le casse-tête est déclaré non-autorisé au cours d'un tour, les essais peuvent être remplacés par des essais supplémentaires, à la discrétion du Délégué WCA.
- 3l) Un casse-tête peut avoir un logo sur une partie colorée, mais si c'est le cas il doit avoir au plus une pièce colorée avec un logo. Exception : pour les épreuves à l'aveugle, un casse-tête ne doit pas avoir de logo.
    - 3l1) Le logo doit être placé sur une des pièces centrales. Exceptions pour les casse-têtes n'ayant pas de pièce centrale :
    ...
    - 3l2) Le logo peut être en relief, gravé, ou être une étiquette recouvrante.
...
- 4b) Les casse-têtes doivent être mélangés en utilisant des séquences de mélange aléatoires générées par ordinateur.
    ...
    - 4b3) Caractéristique d'un programme utilisé pour les mélanges : une séquence de mélange officielle doit permettre d'atteindre une position aléatoire parmi celles nécessitant au moins 2 mouvements pour être résolues (chaque état est équiprobable). Les règles additionnelles suivantes s'appliquent :
...
- 4d) Orientation lors des mélanges :
    - 4d1) Les casse-têtes NxNxN et le Megaminx sont mélangés en commençant avec la face blanche au-dessus (ou la face la plus claire si il n'y en a pas) et la face verte devant (ou la face adjacente la plus sombre s'il n'y en a pas).
...
- 4f) Les séquences de mélanges pour une compétition doivent être générées en utilisant une version officielle d'un mélangeur officiel de la WCA (disponible sur le [site internet de la WCA](https://www.worldcubeassociation.org/regulations/scrambles/)).
...
- 7h) L'espace de compétition doit avoir une zone d'attente pour les compétiteurs.
    - 7h1) L'équipe organisatrice peut demander que chaque compétiteur appelé pour concourir doive rester dans la zone d'attente pour les compétiteurs jusqu'à la fin de tous ses essais pour le tour en cours.
...
- 8a) Une compétition homologuée par la WCA doit :
    ...
    - 8a4) Être annoncée sur le site internet de la WCA, au moins quatre semaines avant le début de la compétition. Exception : Lors de cas particuliers, une compétition peut être annoncée jusqu'à deux semaines avant le début de la compétition, à la discrétion du bureau de la WCA.
    ...
    - 8a8) Être ouverte à tous ceux qui souhaitent participer.
...
- 9a) La WCA régit les compétitions pour des casse-têtes manipulés en tournant leurs faces ("twisty puzzles").
- 9b) Les épreuves officielles de la WCA sont :
    - 9b1) Cube 3x3x3, Cube 2x2x2, Cube 4x4x4, Cube 5x5x5, 3x3x3 à une main, 3x3x3 avec les pieds, Clock, Megaminx, Pyraminx, Skewb, et Square-1.
        - 9b1a) Le format des tours pour ces épreuves est "Moyenne élaguée des 5". Pour un tour combiné, le format est "Meilleur des 2" pour la première phase et "Moyenne élaguée des 5" pour la seconde phase. Exception : lors de cas particuliers, le format des tours pour ces épreuves peut être "Meilleur des X" (où X est 1, 2, ou 3), à la discrétion du bureau de la WCA.
     - 9b2) 3x3x3 résolution optimisée, Cube 6x6x6, et Cube 7x7x7.
        - 9b2a) Les formats des tours pour ces épreuves sont : "Meilleur des X" (où X est 1 ou 2) et "Moyenne des 3".
    - 9b3) 3x3x3 à l'aveugle, 4x4x4 à l'aveugle, 5x5x5 à l'aveugle, et 3x3x3 résolution multiple à l'aveugle.
        - 9b3a) Les formats des tours pour ces épreuves sont : "Meilleur des X" (où X est 1, 2, ou 3).
        - 9b3b) Pour le 3x3x3 à l'aveugle, la WCA prend également en compte le classement pour le format "Moyenne des 3", en se basant sur les temps des tours au format "Meilleur des 3".
- 9f) Les résultats pour un tour sont calculés comme suit :
    ...
    - 9f12) Pour les tours au format "Meilleur des X", le classement est basé sur le meilleur résultat pour chaque compétiteur. Les résultats sont comparés selon les règles suivantes :
        ...
        - 9f12c) Pour la résolution multiple à l'aveugle, le classement est ordonné selon la soustraction du nombre de casse-têtes résolus par le nombre de casse-têtes non résolus (DNF), plus ce résultat est grand, meilleur il est. Si ce nombre est strictement négatif, ou si 1 seul casse-tête est résolu, l'essai n'est pas considéré résolu (DNF). Si plusieurs compétiteurs obtiennent le même résultat, le classement est ordonné selon le temps total de l'essai, où le plus court temps est le meilleur. Si plusieurs compétiteurs obtiennent le même résultat et le même temps, le classement est ordonné selon le nombre de casse-têtes non résolus, plus ce nombre est petit, meilleur il est.
...
- 9g) Un tour combiné se déroule en deux phases d'essais, où les compétiteur sont qualifiés pour la seconde phase si ils effectuent un essai en dessous de la limite au cours de la première phase.
    - 9g2) Le fait qu'un compétiteur soit qualifié pour la phase suivante du tour combiné doit se décider en fonction de son résultat (tous les compétiteurs ayant un meilleur résultat que x) lors de la première phase. (voir la [règle 9f12](regulations:regulation:9f12))
...
- 9p) Si une épreuve a plusieurs tours, alors :
    ...
    - 9p2) Les compétiteurs qualifiés pour le tour suivant doivent être déterminés par un classement (meilleurs x compétiteurs) ou un temps limite (tous les compétiteurs avec un résultat meilleur que x) lors du tour précédent.
        - 9p2a) Pour chaque tour, les conditions de qualification au tour suivant doivent être annoncés avant le début du tour, et ne devraient pas être modifiées après le début du tour. Un tel changement doit être fait à la discrétion du Délégué WCA, qui doit prendre en compte avec attention l'équité de ce changement.
...
- 10d) Chaque pièce du casse-tête doit être physiquement attachée au casse-tête et complètement placée dans la position requise. Exceptions : voir la [règle 5b5](regulations:regulation:5b5).
...
- 10h) Les casse-têtes non couverts par cet article sont jugés selon l'état résolu communément admis du casse-tête, en appliquant les règles correspondantes du 3x3x3.
...
- 11e) Si un incident se produit au cours d'un essai, le Délégué WCA peut accorder à un compétiteur un essai supplémentaire remplaçant l'essai au cours duquel l'incident a eu lieu. Le compétiteur doit faire sa demande oralement ou par écrit au juge et au Délégué WCA, au moment de l'incident et avant de terminer son essai, afin de pouvoir se voir accorder un essai supplémentaire. Effectuer une demande ne garantie pas que celle-ci aboutira à un essai supplémentaire.
    - 11e1) Si un compétiteur se voit accorder un essai supplémentaire, celui-ci doit être réalisé à partir d'une séquence de mélange différente de l'originale. Cette séquence doit être générée à partir d'une version officielle d'un mélangeur officiel de la WCA (voir la [règle 4f](regulations:regulation:4f)).
...
- 12a) Notation pour tous les casse-têtes NxNxN :
...
- 12b) Rotations pour les casse-têtes NxNxN :
...
- A1) Les essais pour les épreuves de résolution rapide doivent respecter les procédures suivantes :
    - A1a) L'équipe organisatrice doit imposer des limites de temps pour les résolutions et/ou les tours.
        ...
        - A1a2) Des limites de temps cumulatives peuvent être imposées (par exemple 3 résolutions dans une limite de temps de 20 minutes - voir la [règle A1a5](regulations:regulation:A1a5)). Le temps passé à obtenir un résultat DNF compte dans la limite de temps cumulative.
        ...
        - A1a4) Le compétiteur doit finir chaque résolution avant la fin de la limite de temps. Si un compétiteur atteint la limite de temps pour une résolution ou un tour, le juge arrête la résolution immédiatement et note le résultat comme étant DNF. Exception : résolution multiple à l'aveugle (voir la [règle H1b1](regulations:regulation:H1b1)).
    ...
    - A1b) Si la limite de temps pour une épreuve est supérieure à 10 minutes, un chronomètre portatif doit être utilisé pour la mesure du temps.
        - A1b1) Le Stackmat doit être utilisé en plus du chronomètre portatif. Exception : pour les épreuves sans inspection où l'on s'attend à ce que le compétiteur dépasse 10 minutes, l'utilisation du Stackmat est facultatif.
...
- A2) Mélange :
    ...
    - A2b) Un mélangeur mélange le casse-tête conformément à l'[Article 4](regulations:article:4).
        - A2b1) Pour le Square-1, l'équipe organisatrice peut demander à ce qu'un objet fin soit placé dans le casse-tête, pour éviter des mouvements accidentels avant le début de l'essai. Si ces objets sont utilisés, cela doit être annoncé avant le début du tour.
    ...
    - A2d) En prenant le casse-tête de la table des mélanges, le juge observe brièvement le casse-tête pour une vérification du mélange. En cas de doute, le juge fait intervenir le mélangeur pour vérification stricte.
        - A2d1) L'équipe organisatrice peut demander aux mélangeurs de prendre des précautions supplémentaires pour vérifier qu'ils ont appliqué les séquences de mélange correctement (par exemple en signant la feuille de score pour confirmer qu'ils ont appliqué la bonne séquence de mélange et vérifié qu'il correspondait à l'image, ou en utilisant une personne supplémentaire pour vérifier les mélanges).
...
- A5) Pendant la résolution :
    - A5a) Pendant l'inspection ou la résolution du casse-tête, le compétiteur ne doit pas communiquer avec une autre personne que le juge ou le Délégué WCA. Pénalité : disqualification de l'essai (DNF).
...
- A6) Fin de la résolution :
    ...
    - A6c) Le compétiteur doit relâcher complètement le casse-tête avant d'arrêter le chronomètre. Pénalité : disqualification de l'essai (DNF). Exception : si aucun mouvement n'a été effectué après avoir arrêté le chronomètre et avant de relâcher le cube, une pénalité de temps (+2 secondes) peut être donnée à la place, à la discrétion du juge.
    ...
    - A6e) Après avoir relâché le casse-tête, le compétiteur ne doit pas toucher le casse-tête avant que le juge n'ait inspecté le casse-tête. Pénalité : disqualification de l'essai (DNF). Exception : Si aucun mouvement n'a été effectué, une pénalité de temps (+2 secondes) peut être donnée à la place, à la discrétion du juge.
...
- A7) Écriture du temps
    ...
    - A7b) Le juge écrit le temps sur la feuille de résultats et signe (ou paraphe) à côté du résultat pour valider que le résultat est correct, complet, écrit dans le bon format, et clairement lisible.
    ...
    - A7c) Le compétiteur doit vérifier le résultat inscrit, et signer (ou parapher) la feuille de résultats pour attester que le résultat est correct, complet, écrit dans le bon format, et clairement lisible. Cela termine l'essai.
        - A7c1) Si un compétiteur ou un juge refuse de signer la feuille de résultats, le Délégué WCA doit résoudre l'incident.
        - A7c2) Si le compétiteur signe (ou marque d'une autre manière) un essai avant de le commencer, il déclare forfait pour cet essai, et le résultat sera considéré comme étant DNS.
        - A7c3) Si le compétiteur signe (ou marque d'une autre manière) un essai après l'avoir commencé mais avant que le juge n'ait fini d'inscrire le résultat, l'essai sera considéré comme non terminé (DNF).
        - A7c4) Le compétiteur ne devrait pas signer (ou marquer d'une autre manière) un essai avant que le juge n'ait inscrit et signé l'essai. Le compétiteur a la pleine responsabilité de s'assurer que le juge et lui ont signé l'essai. Si un essai avec une ou plusieurs signatures manquantes est découvert après que le juge a amené la feuille de résultats au teneur de score (voir la [règle A7f](regulations:regulation:A7f)), il sera considéré comme non terminé (DNF).
...
- C1) Les procédures standards s'appliquent comme décrites dans l'[Article A](regulations:article:A) (Résolution rapide). Les règles supplémentaires qui remplacent les procédures correspondantes dans l'[Article A](regulations:article:A) sont décrites ci-après.
    - C1b) Pendant la résolution, le compétiteur ne doit utiliser qu'une seule main pour manipuler le casse-tête. Pénalité : disqualification de l'essai (DNF).
        ...
        - C1b3) Si certaines parties du corps du compétiteur touchent le casse-tête ou des parties du casse-tête involontairement et sans effectuer de mouvements, cela n'est pas considéré comme une manipalution du casse-tête, à la discrétion du juge.
    - C1c) Pendant la résolution, à partir du moment où un compétiteur manipule le casse-tête avec une main, il ne doit pas le manipuler avec l'autre main. Pénalité : disqualification de l'essai (DNF).
...
- D1) La procédure standard s'applique comme décrite dans l'[Article A](regulations:article:A) (Résolution rapide). Les règles supplémentaires qui remplacent les procédures correspondantes dans l'[Article A](regulations:article:A) sont décrites ci-après.
    ...
    - D1b) Pendant la résolution, le compétiteur ne doit utiliser que ses pieds et le sol pour manipuler le casse-tête. Pénalité : disqualification de l'essai (DNF).
...
- E3) Le compétiteur peut utiliser le matériel ci-après au cours de sa résolution. Pénalité pour utilisation de matériel non autorisé : disqualification de la résolution (DNF).
    ...
    - E3b) Cubes 3x3x3 (au plus 3, non fournis), tels que décrit dans l'[Article 3](regulations:article:3).
...
L'équipe organisatrice peut décider d'appliquer des règles optionnelles pour faciliter l'organisation de la compétition, à la discrétion du Bureau de la WCA.

- Z1) L'équipe organisatrice peut demander aux compétiteurs de fournir leurs casse-têtes au moment de l'inscription.
...
- Z4) L'équipe organisatrice peut limiter le nombre de compétiteurs par épreuve ou par compétition, en se basant soit sur une politique du "premier arrivé, premier servi", ou sur les temps de qualification, ou sur la position dans le classement mondial de la WCA à une date annoncée avant la compétition. Si le nombre de compétiteurs par épreuve ou par compétition est limitée, les règles suivantes s'appliquent :
    - Z4a) Si la limite pour une compétition ou une épreuve est atteinte avant la compétition, l'équipe organisatrice ne doit pas accepter d'inscription sur place pour la compétition ou l'épreuve.
    - Z4b) Les limites de compétiteurs doivent être annoncées en même temps que la compétition. Tout changement de ces limites est à la discrétion du Bureau de la WCA.
    - Z4c) S'il y a plus d'une période d'inscription, l'équipe organisatrice doit annoncer chacune des nouvelles périodes d'inscription au moins 48h avant leur début respectif.
