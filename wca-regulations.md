...
<version>Versão: 1 de janeiro de 2014
...
- 1c) O Delegado da WCA pode delegar responsabilidades noutros membros da equipa de organização, mas é responsável, em última instância, pela forma como estas são conduzidas. O Delegado da WCA numa competição é responsável por:
	...
	- 1c6) Aprovar todos os formatos de eventos e rondas de uma competição, antes que esta comece e alterações que sejam necessárias realizar durante a competição.
...
- 1e) Cada evento necessita ter um ou mais juízes.
    ...
    - 1e2) Todos competidores devem estar disponíveis para ser juízes. Se for necessário ser juiz, um competidor pode ser dispensado apenas por uma razão legítima (ex. não estar familiarizado com um quebra-cabeças), segundo critério do Delegado. Penalidade: desqualificação da competição (ver [Regra 2k](regulations:regulation:2k)).
- 1f) Cada evento necessita ter um ou mais embaralhadores. Exceção: Resolução em Menos Movimentos.
	...
	- 1f2) Cada competidor deve estar disponível para embaralhar. Se for necessário que embaralhe, o competidor pode ser dispensado por um motivo legítimo (ex. não estar familiarizado com a notação de embaralhamento), segundo critério do Delegado. Penalidade: desqualificação da competição (ver [Regra 2k](regulations:regulation:2k)).
- 1g) Cada evento necessita ter um ou mais anotadores de resultados.
	...
	- 1g2) Qualquer alteração feita nas folhas de resultados deve ser feita segundo critério do Delegado da WCA.
...
- 3d) Os quebra-cabeças devem ter autocolantes ou placas coloridas.
	- 3d1) Exceção: Competidores com deficiência visual documentada medicamente podem usar quebra-cabeças com diferentes texturas diferentes em cada face. As texturas ou padrões devem ser uniformes por face. Cada face deve ter uma cor diferente, para facilitar o embaralhamento e a verificação pelo juiz.
    ...
    - 3d3) Os autocolantes/placas/pintura não podem ser mais espessos que 1mm.
...
- 3j) Os quebra-cabeças devem estar limpos, e não podem ter nenhuma marca, peça elevada, dano ou outras diferenças que distingam uma peça de outra peça similar.
    ...
    - 3j3) Autocolantes ondulados ou com texturas cuja orientação possa ser distinguível pelo tato não são permitidos para eventos vendados.
- 3k) Os quebra-cabeças devem ser aprovados pelo Delegado da WCA antes de serem usados na competição.
- 3l) Um quebra-cabeças pode ter um logotipo num autocolante/placa, mas só pode ter, no máximo, um autocolante/placa com um logotipo.
    - 3l1) O logotipo deve estar colocado numa peça central. Exceções para puzzles que não têm peças centrais:
        - 3l1a) Para Pyraminx e 2x2x2, o logotipo pode estar em qualquer peça.
        - 3l1b) Para Square-1, o logotipo deve estar numa peça da camada central.
...
- 4b) Os quebra-cabeças devem ser embaralhados usando sequências de embaralhamento aleatórias, geradas por computador.
    ...
    - 4b3) Especificação para o programa de embaralhamento: Um programa de embaralhamento oficial deve produzir um estado aleatório dentre os que requerem pelo menos dois movimentos para serem resolvidos. Aplicam-se as seguintes adições/exceções:
        ...
        - 4b3c) Pyraminx e Skewb: O estado (aleatório) deve necessitar de, pelo menos, 7 movimentos para ser resolvido.
...
- 4d) Orientações de embaralhamento:
    ...
    - 4d4) O Clock é embaralhado começando com a capa interior mais escura na frente (das duas orientações possíveis para embaralhamento) e com os ponteiros nas 12 horas a apontar para cima.
...
- 4g) Depois de embaralhar o quebra-cabeças, o embaralhador deve verificar se ele foi embaralhado corretamente. Se o estado do quebra-cabeças estiver incorreto, o embaralhador deve corrigi-lo (ou seja, resolvendo o quebra-cabeças e aplicando o embaralhamento novamente).
    - 4g1) Exceção: Para os eventos 6x6x6, 7x7x7 e Megaminx não é necessário corrigir o embaralhamento, a critério do Delegado da WCA.
...
- 5b) Se um defeito no quebra-cabeças ocorrer durante uma tentativa, o competidor pode escolher entre reparar o defeito e continuar a tentativa, ou pará-la.
    ...
    - 5b4) Durante tentativas de eventos vendados, (ver [Regra B4](regulations:regulation:b4)), todos os defeitos no quebra-cabeças devem ser reparados pelo competidor enquanto vendado. Penalidade: desqualificação da resolução (DNF).
...
- 10h) Quebra-cabeças não especificados neste artigo são julgados de acordo com o estado de resolução definido pelo objetivo do quebra-cabeças, aplicando-se as regras relevantes relativas ao Cubo de Rubik.
    - 10h1) O estado resolvido do Clock é quando todos os dezoito relógios apontam para as 12 horas.
...
- A1) Resoluções em velocidade devem seguir o procedimento seguinte.
    ...
    - A1b) Se o tempo limite para uma resolução for maior que 10 minutos, um cronómetro manual é usado para medir o tempo.
        - A1b1) Para eventos com inspeção, o uso de um Cronómetro Speed Stacks tem de ser usado em conjunto com um cronómetro manual. Para eventos sem inspeção, onde o competidor é esperado que exceda 10 minutos, o uso de um Cronómetro Speed Stacks é opcional.
...
- A4) Iniciando a resolução:
    ...
    - A4d) O competidor inicia a resolução certificando-se de que a luz do Cronómetro Speed Stacks está verde e, então, tirando as suas mãos do Cronómetro Speed Stacks (iniciando-o desta forma).
...
- A6) Finalizando a resolução:
    - A6a) O competidor finaliza a resolução largando o quebra-cabeças e parando o Cronómetro Speed Stacks. Se um cronómetro estiver a ser usado pelo juiz, este pára assim que o competidor fizer isto.
        - A6a1) Se um cronómetro manual está a ser usado como marcador de tempo, o competidor finaliza a resolução soltando o quebra-cabeças e notificando o juiz de que terminou a resolução. O juiz pára a contagem assim que o competidor fizer isto.
        - A6a2) Quando um cronómetro estiver a ser usado, sem o uso do cronómetro Speed Stacks, o sinal padrão do competidor consiste em soltar o(s) quebra-cabeças(s) e colocar as suas mãos na superfície, com as palmas voltadas para baixo. O competidor e o juiz podem acordar outra notificação apropriada antes do início da resolução.
    ...
    - A6g) O juiz determina se o quebra-cabeças está resolvido. Ele não pode fazer movimentos ou alinhar faces ao examinar o quebra-cabeças.
...
- A7) Registrando resultados:
    ...
    - A7c) O juiz e o competidor têm que ambos verificar o resultado registado e assinar (ou colocar as suas iniciais) a folha de resultados para reconhecer que o resultado está correto, completo, devidamente formatado e facilmente legível. Isto termina a tentativa.
        ...
        - A7c2) O competidor não deve assinar uma tentativa na folha de resultados antes que o juiz tenha registado o seu resultado final Se um competidor assinar (ou marcar) uma tentativa antes de a iniciar, ou antes que o juiz tenha apontado o resultado, este desiste da tentativa e o resultado é considerado DNS.
...
- B2) Iniciando a resolução:
    ...
    - B2d) O competidor inicia a resolução removendo as suas mãos do cronómetro Speed Stacks, iniciando-o e começando a resolução.
    ...
    - B2f) Se um cronómetro manual estiver a ser usado como única forma de medir o tempo, o competidor coloca as suas mãos na mesa (em vez de no cronómetro Speed Stacks). Após o competidor confirmar a sua prontidão, ele começa a resolução ao levantar a cobertura do quebra-cabeças. O juiz inicia o cronómetro manual assim que o competidor iniciar a resolução.
...
- E3) O competidor pode usar os seguintes objetos durante a resolução. Punição por usar objetos não-autorizados: desqualificação da resolução (DNF).
    ...
    - E3b) Cubos de Rubik (no máximo 3, fornecidos pelo competidor).
