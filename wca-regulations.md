...
<version>Версия: 3 апреля 2014 г.
...
Это не официальные Положения WCA, а вольный перевод. В случае возникновения сомнений следует обращаться к оригинальным Положениям. В переводе возможны ошибки! Вопросы и замечания по поводу перевода отправляйте по электронной почте на rostoav@mail.ru.
...
Перевод осуществляли: [Антон Ростовиков](http://worldcubeassociation.org/results/p.php?i=2009ROST01), [Олег Гриценко](http://worldcubeassociation.org/results/p.php?i=2011GRIT01).

Перевод корректировали: [Оксана Рузаева](http://worldcubeassociation.org/results/p.php?i=2010RUZA01), [Антон Горячих](http://worldcubeassociation.org/results/p.php?i=2009GORY01), [Дмитрий Анискин](http://worldcubeassociation.org/results/p.php?i=2011ANIS01).
...
- 1e) Для проведения каждой дисциплины необходимы один или более судей.
    ...
    - 1e2) Любой незанятый участник может быть назначен судьёй, если это требуется команде организаторов.
    - 1e2) Каждый участник может быть назначен судьёй. Участник может отказаться от судейства только по уважительной причине (например, он незнаком с головоломкой), по усмотрению Делегата. Наказание при отказе участника по неуважительной причине: дисквалификация с соревнований (см. [Положение 2k](regulations:regulation:2k)).
- 1f) Для проведения каждой дисциплины необходимы один или более скрамблёров. Исключение: дисциплина на количество ходов.
    ...
    - 1f2) Каждый участник может быть назначен скрамблёром. Участник может отказаться от скрамблёрства только по уважительной причине (например, он незнаком с языком вращений), по усмотрению Делегата. Наказание при отказе участника по неуважительной причине: дисквалификация с соревнований (см. [Положение 2k](regulations:regulation:2k)).
...
- 3d) Головоломки должны иметь цветные части одного из следующих типов: цветные наклейки, цветные пластинки, цветной пластик или нарисованные/напечатанные цвета. Все цветные части должны быть сделаны из однотипного материала.
    ...
    - 3d3) Наклейки/пластинки должны быть не толще 1.5 мм. Исключение: пластинки для Мегаминкса могут быть немного толще 1.5 мм, на усмотрение Делегата.
- 3h) Модификации, которые совершенствуют основную структуру головоломки, запрещены. Модифицированные версии головоломок разрешены только в том случае, если модификация не дает дополнительной доступной информации участнику (например, ориентацию или идентификацию элементов) по сравнению с немодифицированной версией этой головоломки.
    ...
    - 3h2) Головоломки, у которых цветные части видны изнутри, запрещены.
    ...
    - 3h4) Для Clock'ов можно использовать свои "вкладыши" (той же формы и размера, как и оригинальные), на усмотрение Делегата. На вкладышах должны быть чётко обозначены направления 12 часов, совпадающие с оригинальными.
...
- 3l) Головоломки могут иметь логотип на наклейке/пластинке, максимум один.
...
- 4b) Головоломки должны быть перемешаны с помощью сгенерированных на компьютере скрамблов.
    ...
    - 4b3) Подробности генератора скрамблов: скрамбл должен приводить к случайному состоянию, для сборки из которого необходимо не менее 2 ходов. Также есть следующие дополнения/исключения:
        ...
        - 4b3c) Pyraminx и Skewb: для сборки из (случайного) состояния головоломки должно быть необходимо не менее 7 ходов.
        - 4b3d) Square-1: для сборки из (случайного) состояния головоломки должно быть необходимо не менее 11 ходов.
        - 4b3e) 5x5x5 Cube, 6x6x6 Cube, 7x7x7 Cube, and Megaminx: достаточно много случайных движений (вместо случайного состояния), для сборки из которого необходимо не менее 2 ходов.
- 4d) Ориентация головоломок при перемешке:
    ...
    - 4d4) Перемешивание Clock'а начинается в положении более тёмным "вкладышом" спереди (из двух возможных положений для перемешки), все циферблаты указывают на 12 часов.
    - 4d5) Перемешивание Skewb'а начинается в положении белой стороной наверх (при отсутствии белой стороны наиболее светлой) и зелёной стороной вперёд-налево (при отсутствии зелёной стороны тёмной соседней стороной).
...
- 9b) Официальные головоломки и форматы дисциплин WCA:
    - 9b1) Кубик Рубика, Кубик 2х2х2, Кубик 4х4х4, Кубик 5х5х5, Clock, Мегаминкс, Пирамидка, Square-1, Skewb и сборка кубика Рубика одной рукой.
        - 9b1a) Форматами для этих дисциплин являются: "Лучшая из X" (где X равно 1, 2, или 3), и "Среднее WCA из 5".
    - 9b2) Сборка кубика Рубика ногами, сборка кубика Рубика на количество ходов, Кубик 6х6х6 и Кубик 7х7х7.
        - 9b2a) Форматами для этих дисциплин являются: "Лучшая из X" (где X равно 1 или 2) и "Среднее из 3".
    - 9b3) Сборка кубика Рубика вслепую, сборка кубика 4х4х4 вслепую, сборка кубика 5х5х5 вслепую и мульти-блайнд (сборка нескольких кубиков Рубика вслепую).
        - 9b3a) Форматами для этих дисциплин являются: "Лучшая из X" (где X равно 1, 2, или 3).
        - 9b3b) Для сборки кубика Рубика вслепую WCA также учитывает рейтинг и рекорды "Среднее из 3", основанные на результатах раундов формата "Лучшая из 3".
...
- 10f) Допустимые пределы поворотов для головоломок:
    ...
    - 10f3) Пирамидка и Skewb: не более 60 градусов.
...
- A1) Попытки в скоростной сборке должны проходить по следующей процедуре:
    - A1a) Команда организаторов может установить лимиты по времени для сборок и/или для раундов.
        - A1a1) Лимит для сборки по умолчанию равен 10 минутам, но команда организаторов может сделать его больше или меньше.
        - A1a2) Могут быть установлены суммарные лимиты (например, 20 минут на 3 сборки). Если в какой-либо попытке участник получает DNF, то реальное время его сборки всё равно считается в суммарном лимите.
        ...
        - A1a4) Участник должен заканчивать сборки до того, как истечёт лимит по времени. Если лимит для сборки или раунда исчерпан, судья немедленно останавливает попытку и ставит DNF. Исключение: мульти-блайнд (см. [Положение H1b1](regulations:regulation:H1b1)).
        - A1a5) Сборка укладывается в лимит по времени, если и только если конечный результат, после применения всех штрафов, меньше лимита по времени. Исключение: мульти-блайнд (см. [Положение H1b1](regulations:regulation:H1b1)).
    - A1b) Если лимит по времени для сборки больше 10 минут, для измерения времени должен использоваться секундомер.
        - A1b1) Для дисциплин с преинспекцией должен использоваться стакмат вместе с секундомером. Для дисциплин без преинспекции, где участник, скорее всего, превысит 10 минут, стакмат можно не использовать.
...
- A4) Начало сборки:
    - A4b) Участник кладёт руки на стакмат. Его пальцы должны дотрагиваться до сенсоров, а ладони должны быть направлены вниз. Штраф: +2 секунды.
...
- A6) Окончание сборки:
    ...
    - A6c) Участник должен полностью отпустить головоломку перед остановкой сборки. Штраф: +2 секунды.
    ...
    - A6g) Судья определяет, собрана ли головоломка. При этом он не должен делать ходы и выравнивать грани.
...
- A7) Запись результатов:
    ...
    - A7c) Судья и участник должны оба проверить записанный результат и подписать его (или поставить инициалы) на карточке, принимая, что результат верный, полный, правильно отформатирован и хорошо читаемый. После этого попытка заканчивается.
        - A7c1) Если участник или судья отказывается принимать результат и подписываться, WCA Делегат должен разрешить спор.
        - A7c2) Участнику не разрешается подписывать попытку на карточке до того, как судья записал в неё результат этой попытки. Если участник подписывает (или иным способом помечает) попытку до того, как он её начал, или до того, как судья закончил записывать результат, он теряет эту попытку, и её результат DNS.
...
- B2) Начало попытки:
    - B2a) Судья сбрасывает таймер(ы) и спрашивает "Готов?", как в [Положении A3b1](regulations:regulation:A3b1). После этого у участника есть минута, чтобы начать попытку, в противном случае он теряет свою попытку (DNS), по решению судьи.
    - B2b) Участник кладёт руки на стакмат. Его пальцы должны дотрагиваться до сенсоров, а ладони должны быть направлены вниз. Штраф: +2 секунды.
...
- E3) Во время попытки участник может использовать только нижеперечисленные предметы. Штраф за использование посторонних предметов: дисквалификация попытки (DNF).
    ...
    - E3b) Кубики Рубика (не более трёх, свои).
