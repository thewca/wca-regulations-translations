...
- 1h++) [建议] 所有项目最后一轮中的每一次还原，以及最少步项目的所有还原，对于所有的选手应该使用同样的打乱（即只有一组）。
...
- 4f++) [提醒] 如果WCA代表在比赛中生成了额外的打乱，这些打乱必须被存档（见[规则1c3a](regulations:regulation:1c3a)）。
...
- 11e2+) [附加] 对于某次额外的尝试又导致额外的尝试的情况，选手应该持续进行额外的尝试，直到产生了足够代替原来常规还原的有效还原。这些有效的额外还原从小到大依次代替原来常规的还原。
- 11e2++) [举例] 假设在正常的5次还原中，第2次和第4次还原产生了两个额外的还原。那么在完成了5次正常还原之后，选手不停的进行额外的尝试，直到产生了两个有效还原。其中第一个还原用于代替原来的第2次还原，第二个还原用于代替原来的第4次还原。
