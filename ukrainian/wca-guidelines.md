...
Керівництво WCA доповнює [Положення WCA](regulations:top). Будь ласка, перегляньте Положення для отримання детальнішої інформації про WCA.

### Нумерація

Керівництва нумеруються відповідно до пов’язаних Положень. Зверніть увагу, що декілька Керівництв можуть відповідати одному й тому ж Положенню, а деякі Керівництва відповідають Положенням, що більше не існують.

### Ярлики

Щоб надати більше інформації, кожне Керівництво класифікується за допомогою одного з наступних позначень. Зверніть увагу, що це слід розглядати як метадані, а не як опис важливості.

- <label>[ДОПОВНЕННЯ] Додаткова інформація, що доповнює Положення.
- <label>[УТОЧНЕННЯ] Інформація, що дає відповіді на можливі питання щодо тлумачення Положень.
- <label>[ПОЯСНЕННЯ] Інформація, що роз’яснює намір Положень.
- <label>[РЕКОМЕНДАЦІЯ] Те, що не є суворо обов’язковим, але має бути виконано, якщо можливо.
- <label>[НАГАДУВАННЯ] Інформація, що може бути висвітлена іншими Положеннями/Керівництвами, але важлива для повторного наголошення.
- <label>[ПРИКЛАД] Приклад застосування Положенню.
...
- 1c++) [УТОЧНЕННЯ] Делегати WCA можуть відвідувати змагання, не будучи призначеними як Делегати WCA цього заходу. Термін «Делегат WCA» не стосується їх, доки вони не отримають відповідного доручення від призначеного Делегата (див. [Керівництво 1c+](guidelines:guideline:1c+)).
...
- 2i+) [ДОПОВНЕННЯ] Хоча учасник може взяти секундомір, щоб подивитися поточний час (якщо він не в масці), він не повинен запускати, зупиняти, ставити на паузу або іншим чином втручатися у вимірювання часу. Виняток: учасник може зупинити секундомір по завершенні спроби, якщо суддя не доступний негайно (див. [Положення A6a1](regulations:regulation:A6a1)).
- 2i++) [ДОПОВНЕННЯ] Організатори можуть надати учаснику неофіційний секундомір для перегляду часу (запущений одночасно з основним секундоміром); у цьому випадку учаснику заборонено торкатися офіційного секундоміра. Виняток: див. виняток у [Керівництві 2i+](guidelines:guideline:2i+).
- 2i+++) [НАГАДУВАННЯ] Bluetooth‑головоломки вважаються електронними пристроями.
- 2i++++) [УТОЧНЕННЯ] Учасник вважається таким, що користується електронним пристроєм, лише якщо він використовує його з певною метою.
...
- 2s++) [ПРИКЛАД] Учасникам, чиї обставини (наприклад, релігійні) не дозволяють їм змагатись у певний час або дату, може бути дозволено зібрати свої збірки в інший час на розсуд Делегата WCA. Делегат WCA повинен зважити доступність ресурсів змагань у таких ситуаціях. Це включає можливість змагання у наступному раунді(ах) до того як попередній раунд(и) закінчились.
...
- 2s1+) [ПРИКЛАД] Приклади таких умов: сліпий учасник може використовувати другу руку для розпізнавання елементів під час збірки однією рукою, або може використовувати другу головоломку з спеціальними деталями під час стадії запам'ятовування збірки 3x3x3 Всліпу.
...
- 3h2a+) [ДОПОВНЕННЯ] Приклади прозорих частин, що не розкривають додаткової інформації про стан головоломки: внутрішні частини механізму головоломки, прозорі корпуси Clock.
- 3h4+) [УТОЧНЕННЯ] Для Clock дозволені візуальні модифікації, що полегшують визначення орієнтації головоломки, оскільки традиційний дизайн уже надає цю інформацію.
- 3j++) [ПРИКЛАД] Є [Візуальний посібник](https://drive.google.com/file/d/1m6THsA8fXRN7QFM4ApJbm6eVODKGbMLx/view) для [Положення 3j](regulations:regulation:3j).
...
- 3l++) [УТОЧНЕННЯ] Логотипи дозволені для дисципліни 3×3×3 Всліпу, але не для інших дисциплін всліпу, включно з 3×3×3 Мульти‑Блайнд.
...
- 4b2++) [ДОПОВНЕННЯ] Організатори змагання повинні забезпечити, щоб скрамблери, набори скрамблів та частково чи повністю перемішані головоломки були візуально ізольовані від учасників (див. [Положення A2c](regulations:regulation:A2c)). Наприклад, скрамблерів можна розмістити за стінкою, або використати достатньо високий роздільник (наприклад, ширму навколо столу скрамблерів), щоб учасники не могли бачити головоломки під час скрамблінгу.
...
- 4d++) [ДОПОВНЕННЯ] Дозволено, щоб головоломка змінювала свою орієнтацію під час переміщення від скрамблера до станції складання, доки ніхто не намагається вплинути на випадковість орієнтації (див. [Положення A2e1](regulations:regulation:A2e1)).
...
- 4g1b+) [УТОЧНЕННЯ] Для дисципліни 5×5×5 Всліпу неправильні стани головоломки завжди мають бути виправлені.
...
- 5b5f+) [ПРИКЛАД] Для [Положення 5b5f](regulations:regulation:5b5f) доступний [Візуальний посібник](https://drive.google.com/file/d/15XszaCGNvy3Dk6X6qERzZWZaDH1RH04z/view).
- 5b5f++) [ПРИКЛАД] Ребро куба 4×4×4, повернене на місці, вважається зібраним.
- 5b5f+++) [ПРИКЛАД] Фліпнутий кутовий елемент вважається розташованим у припустимій позиції, але така позиція не робить елемент зібраним.
...
## <article-7><environment><environment> Стаття 7: Оточення
...
- 9b++) [ДОПОВНЕННЯ] Дисципліни, відмінні від перелічених у [Положенні 9b](regulations:regulation:9b), можуть проводитися під час змагання, але вважатимуться неофіційними і тому не будуть включені до офіційних результатів змагання.
...
- 9f4+) [УТОЧНЕННЯ] Результат спроби повинен бути DNF, якщо учасник почав спробу, показавши готовність (див. [Положення A3b2](regulations:regulation:A3b2)), але спроба була дискваліфікована.
- 9f5+) [УТОЧНЕННЯ] Якщо учасник не мав права виконати спробу (наприклад, у раунді з "катоффом"), у нього немає результату для цієї спроби.
- 9l1+) [УТОЧНЕННЯ] Результат DNF зазвичай вважається чинним результатом. Додаткові спроби не повинні надаватися за використання неприпустимої головоломки, виявленої лише після завершення раунду (див. [Положення 3k2a](regulations:regulation:3k2a)).
...
- 10e1+) [УТОЧНЕННЯ] Для Square‑1, через здатність головоломки змінювати форму, метрика невирівнювань, визначена в [Положенні 10f4](regulations:regulation:10f4), відрізняється від метрики нотації, яку використовує програма скрамблу, визначеної в [Положенні 12c4](regulations:regulation:12c4).
- 10f+) [ПОЯСНЕННЯ] Межі невирівнювань вибрано так, щоб вони давали природну межу між одним станом головоломки (без штрафу) та станом, що на один хід від нього.
- 10f4+) [УТОЧНЕННЯ] Під час підрахунку ходів у разі невирівнювання наприкінці спроби X та Y розглядаються окремо. Приклад: (5, 1) вважається одним рухом від зібраного стану, а (5, 5) — двома.
- 10h1+) [ДОПОВНЕННЯ] Зібраний стан Clock не залежить від розхитаних чи відсутніх пінів.
...
- 11e++++) [НАГАДУВАННЯ] Спроба вважається завершеною після того, як учасник перевірив записаний результат і підписав картку результатів (див. [Положення A7c](regulations:regulation:A7c)).
...
- 11e1+) [НАГАДУВАННЯ] Додаткова спроба має бути перемішана за допомогою немодифікованого скрамблу, згенерованого офіційною програмою (див. [Положення 4b](regulations:regulation:4b), [Керівництво 4b+](guidelines:guideline:4b+)).
...
- 11i1+) [РЕКОМЕНДАЦІЯ] Для учасників, у яких очікується виконання цих критеріїв, скрамбли варто перевіряти другим скрамблером до видачі (див. [Керівництво 4g+](guidelines:guideline:4g+)).
...
- 12g3+) [НАГАДУВАННЯ] Оскільки скрамбл‑послідовності для Clock завершуються ходом X+ або X‑, усі піни опускаються після повного застосування скрамблу.
...
- A1a3+) [НАГАДУВАННЯ] Команда організаторів і Делегат WCA повинні пам’ятати, що ліміти часу впливають на стратегію учасників (наприклад, швидке виконання перших спроб, щоб пройти "катофф"), і що зміна лімітів після початку раунду може несправедливо поставити частину учасників у невигідне становище.
...
- A3c1+) [УТОЧНЕННЯ] Для Clock учасник може змінювати положення пінів під час інспекції (див. [Regulation 12i1](regulations:regulation:12i1)).
...
- A6b1+) [ПОЯСНЕННЯ] Значення 0,06 с вибрано, щоб врахувати можливі збої Stackmat‑таймера.
...
## <article-B><blindfolded><blindfoldedsolving> Стаття B: Збірка Всліпу

- B1+) [НАГАДУВАННЯ] Учасник повинен використовувати головоломку без текстур, маркувань або інших ознак, які відрізняють схожі елементи (див. [Regulation 3k](regulations:regulation:3k)). На це слід звернути особливу увагу для збіркок всліпу. Виняток: для 3×3×3 Всліпу головоломка може мати будь‑які логотипи, дозволені [Regulation 3l](regulations:regulation:3l).
...
- B4d+) [УТОЧНЕННЯ] Для 3×3×3 Всліпу учаснику дозволено на дотик визначати місце розташування дозволеного логотипа (див. [Regulation 3l](regulations:regulation:3l)) під час фази з пов’язкою.
...
- E2c2+) [ПРИКЛАД] Не вважається однозначною послідовністю рухів: кілька розв’язків без чітко зазначеного одного; послідовність з неоднозначними символами (наприклад, літера, схожа і на «B», і на «R»); послідовність із зірочками чи стрілками, що позначають ходи, які треба виконати не в порядку запису (наприклад, «вставки» чи «премуви», не інтегровані у текст за допомогою корректної нотації); послідовність, що не записана лінійно у порядку читання; будь‑яка конфігурація символів, яку не можна однозначно інтерпретувати. Винятки: малі типографічні виправлення (наприклад, закреслені ходи з чітко написаною заміною, ходи, дописані у нижній/верхній індекс між іншими).
...
- E2c3+) [УТОЧНЕННЯ] Якщо хід не повністю закреслено чи замальовано і незрозуміло, чи він належить до розв’язку, суддя має вважати послідовність неоднозначною (див. [Regulation E2c2](regulations:regulation:E2c2) та [Guideline E2c2+](guidelines:guideline:E2c2+)).
...
- E2e++) [ПРИКЛАД] Приклад рішень що повинні бути дискваліфіковані: рішення починається тими самими 4 і більше ходами, що й інверсія скрамблу.
...
- H1b1++) [ДОПОВНЕННЯ] Суддя може дозволити учаснику продовжити неофіційно, але спробу спершу слід зупинити й оцінити повністю згідно Положенням.
