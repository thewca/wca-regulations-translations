...
- 3h) Модифікації, що розширюють базову концепцію головоломки, не допускаються. Модифіковані версії дозволені лише, якщо вони не надають додаткової інформації порівняно з немодифікованою версією.
    ...
    - 3h5) Для Clock розхлябані піни (тобто такі, що перемикаються лише під дією гравітації), не вважаються допустимим зношуванням головоломки, і такі головоломки не допускаються.
- 3j) Головоломки мають бути чистими й без маркувань, припіднятих елементів або пошкоджень, що відрізняють елементи. Виняток: логотип (див. [Правило 3l](regulations:regulation:3l)).
    ...
    - 3j3) Текстуровані частини, що дозволяють відчувати орієнтацію елементів на дотик, заборонені для дисциплін всліпу.
...
- 3l) Головоломка може мати один чи кілька логотипів на кольоровому елементі, але тільки на одному елементі. Виняток: для 4×4×4 Всліпу, 5×5×5 Всліпу та 3×3×3 Мульти-Блайнд логотипи заборонені.
    - 3l1) Логотип має бути на центральному елементі. Винятки для головоломок без центрального елементу:
        - 3l1a) Для Pyraminx і 2×2×2 логотип може бути на будь‑якому елементі.
        - 3l1b) Для Square‑1 логотип має бути на елементі екваторіального слою.
...
- 4b) Набори скрамблів для змагань мають генеруватися офіційною актуальною версією офіційної програми скрамблів WCA (доступна [на сайті WCA](https://www.worldcubeassociation.org/regulations/scrambles/)).
    ...
    - 4b3) Вимога до програми скрамблів: офіційний скрамбл має генерувати випадковий стан з усіх станів, що потребують принаймні 2 рухи до розв’язку (рівноймовірно). Додаткові вимоги/винятки:
        - 4b3a) Для дисциплін всліпу скрамбл має випадково орієнтувати головоломку (рівноймовірно кожна орієнтація).
        - 4b3b) 2×2×2 Куб: випадковий стан має вимагати не менше 4 рухів до розв’язку.
        - 4b3c) Skewb: випадковий стан має вимагати не менше 7 рухів.
        - 4b3d) Square‑1: випадковий стан має вимагати не менше 11 рухів.
        - 4b3e) 5×5×5, 6×6×6, 7×7×7 Куби та Megaminx: достатня кількість випадкових рухів (замість випадкового стану), але стан після скрамблу має вимагати щонайменше 2 рухи.
        - 4b3f) Pyraminx: випадковий стан має вимагати не менше 6 рухів.
...
- 4d) Орієнтація для скрамблу:
    - 4d1) NxNxN Куби та Megaminx: скрамбл починається з білої грані (якщо неможливо — найсвітлішої) зверху та темної суміжної зеленої грані (якщо неможливо — найтемнішої суміжної) спереду.
    - 4d2) Pyraminx: скрамбл починається з жовтої грані (якщо неможливо — найсвітлішої) знизу та зеленої грані (якщо неможливо — найтемнішої суміжної) спереду.
    - 4d3) Square‑1: скрамбл починається з темнішого кольору спереду (з 2 можливих орієнтацій).
    - 4d4) Clock: скрамбл починається з будь‑якого боку спереду і з 12 годиною вгору.
    - 4d5) Skewb: скрамбл починається з білої грані (якщо неможливо — найсвітлішої) зверху та зеленої грані (якщо неможливо — найтемнішої суміжної) спереду‑ліворуч.
- 4g) Після застосування скрамблу скрамблер має перевірити правильність стану. Якщо стан неправильний, скрамблер має його виправити (наприклад, зібрати головоломку та застосувати скрамбл заново).
    - 4g1) Винятки:
        - 4g1a) Для 6×6×6, 7×7×7 Кубів і Megaminx виправлення не є обов’язковим, на розсуд Делегата WCA.
...
- 5b) Якщо під час спроби виникає дефект головоломки, учасник може або виправити дефект і продовжити спробу, або зупинити спробу. Учасникові заборонено навмисно спричиняти дефект, окрім випадку, коли це робиться для виправлення попереднього дефекту (див. [Правило 5b3b](regulations:regulation:5b3b) та [Правило 5b3c](regulations:regulation:5b3c)). Приклади навмисного спричинення дефекту: зняття прикріпленої центральної кришечки, поворот кутового елемента, відклеювання наклейки.
    ...
    - 5b4) Під час фази всліпу (див. [Правило B4](regulations:regulation:B4)) усі виправлення мають виконуватися із зав’язаними очима. Покарання: дискваліфікація спроби (DNF).
    ...
    - 5b6) Визначення: елемент — це одна чи кілька повністю з’єднаних частин, які залишаються з’єднаними та не рухаються відносно одна одної під час нормальної роботи головоломки (наприклад, кришечка центра 3×3×3, кутик Pyraminx, кутовий елемент 3×3×3 без однієї грані, одна грань кутового елемента 3×3×3).
...
- 9b) Офіційні дисципліни WCA:
    - 9b1) 3×3×3 Куб, 2×2×2 Куб, 4×4×4 Куб, 5×5×5 Куб, 3×3×3 Однією Рукою, Clock, Megaminx, Pyraminx, Skewb і Square‑1.
    ...
    - 9b3) 3×3×3 Всліпу, 4×4×4 Всліпу, 5×5×5 Всліпу.
...
- 10f) Межі допустимого зміщення:
    ...
    - 10f2) Megaminx: максимум 36°.
    - 10f3) Pyraminx і Skewb: максимум 60°.
    - 10f4) Square‑1: максимум 45° (U/D) чи 90° (/).
- 10h) Головоломки, не вказані у цій статті, оцінюються за зібраним станом, визначеним загальноприйнятою метою головоломки.
    - 10h1) Зібраний стан Clock досягнуто, коли всі 18 внутрішніх циферблатів вказують на 12 годину.
...
- 11i) Якщо після завершення спроби з’ясовується, що головоломка була заскрамблена неправильно, застосовуються такі правила:
    - 11i1) У наступних випадках має бути надана додаткова спроба на заміну, якщо додаткова спроба не надана, результатом є DNS:
        ...
        - 11i1e) Виняток: для 5×5×5, 6×6×6, 7×7×7 Кубів, Megaminx та 3×3×3 Мульти-Блайнд додаткова спроба не обов’язкова у наведених вище випадках.
...
- 12c) Нотація для Square‑1:
    ...
    - 12c4) Метрика для Square‑1: (X, Y) рахується як один рух, “/” рахується як один рух.
- 12d) Нотація для Megaminx (лише для скрамблінгу):
    - 12d1) Рухи граней:
...
- 12e) Нотація для Pyraminx:
    - 12e1) Головоломку орієнтовано так, що нижня грань повністю горизонтальна, а фронтальна грань звернена до того, хто тримає Pyraminx.
...
- 12i) Визначення: рухом вважається будь‑яка зміна стану головоломки згідно з наведеними вище нотаціями, включно зі зміщеннями понад межі описані в [Правилі 10f](regulations:regulation:10f).
    - 12i1) Виняток: для Clock рухами вважають лише зміни положення внутрішніх циферблатів; зміни положення пінів рухами не вважаються.
...
- A2) Скрамблінг:
    ...
    - A2b) Скрамблер скрамблить головоломку відповідно до [Статті 4](regulations:article:4).
        - A2b1) Для Square‑1 організаційна команда може вимагати вставляння тонкого предмета у головоломку, щоб запобігти випадковим рухам до початку спроби. Якщо такі предмети використовуються, про це слід оголосити перед початком раунду.
...
- A3) Інспекція:
    ...
    - A3c) Під час інспекції учасник може взяти головоломку до рук.
        ...
        - A3c4) Для Square‑1, якщо організаційна команда вимагала вставити тонкий предмет (див. [Правило A2b1](regulations:regulation:A2b1)), учасник може вийняти його під час інспекції.
        - A3c5) Для Square‑1 учасник не карається за випадкові рухи в межах [Правила 10f](regulations:regulation:10f).
...
- B4) Фаза всліпу:
    - B4a) Учасник надягає пов’язку, розпочинаючи фазу всліпу.
    ...
    - B4d) Учаснику заборонено дивитися на головоломку протягом усієї фази всліпу. Покарання: DNF.
...
- H1) Дотримуються стандартних процедур збірки всліпу, описаних у [Статті B](regulations:article:B) (Збірка всліпу). Нижче наведено додаткові правила, які мають пріоритет над відповідними процедурами в [Статті B](regulations:article:B).
