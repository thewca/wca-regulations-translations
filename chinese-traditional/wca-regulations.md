...
- 4g) 轉亂完一顆方塊後，轉亂員必須確認方塊有被正確轉亂。如果方塊的轉亂狀態不正確，方塊必須被修正（例如：先還原方塊，再轉亂一次）。
    ...
    - 4g2) 例外：魔錶Clock，如果在運輸傳遞或是開蓋的過程中按鈕的狀態受到影響，按鈕可以不用被修正。
...
- 9u) 如果以下條件全部同時達成，一場比賽將被視為已結束：
    ...
    - 9u2) WCA代表宣布比賽完成。如果WCA代表沒有宣布比賽完成，至少要滿足以下一個條件：
...
- A3) 觀察：
    ...
    - A3b) 必要時，裁判將計時器開啟且歸零。如果使用的計時器是Gen5 Pro計時器，裁判必須要確認計時器是設定到 2-Pad 模式。另外，裁判需準備碼錶紀錄觀察時間。
