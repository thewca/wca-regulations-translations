...
- [UITLEG] Informatie om de bedoeling van de Reglementen te verduidelijken.- [AANBEVELING] Iets wat niet strikt verplicht is, maar wat indien mogelijk dient te worden gedaan.- [HERINNERING] Informatie die door andere Reglementen/Richtlijnen kan worden beantwoord maar waarvan de relevantie de moeite van het herhalen waard is.- [VOORBEELD] Een voorbeeld van hoe een Reglement moet worden toegepast.
...
- 1h1+) [VERDUIDELIJKING] Scramblers/judges dienen alleen voor andere deelnemers in dezelfde groep te scramblen/jureren als het belangrijk is voor de logistiek van de wedstrijd.
- 1h1++) [VERDUIDELIJKING] Voor 3x3x3 Met minste draaien mogen judges deelnemers in hun eigen groep jureren voordat ze hun poging hebben voltooid (d.w.z. wanneer ze deelnemen).
...
- 2c2+) [VERDUIDELIJKING] Een WCA profiel is de verzameling van data gerelateerd aan een deelnemer en bevat zijn/haar persoonlijke informatie (naam, land van vertegenwoordiging, gender en geboortedatum) evenals al hun resultaten in officiële WCA wedstrijden.
- 2d+) [AANVULLING] De geboortedatum en contactgegevens dienen speciaal te worden beveiligd.
- 2d++) [AANBEVELING] Als een derde partij (bijvoorbeeld een journalist) het organisatieteam vraagt om in contact te worden gebracht met een deelnemer, dient eerst aan de deelnemer toestemming te worden gevraagd.
...
- 2i+) [AANVULLING] Hoewel de deelnemer een stopwatch mag oppakken om de huidige tijd te bekijken (als hij/zij niet geblinddoekt is), mag hij/zij de tijdwaarneming van de stopwatch niet starten, stoppen, pauzeren of anderszins beïnvloeden.
- 2i++) [AANVULLING] Het organisatieteam mag de deelnemer een onofficiële stopwatch geven om de verstreken tijd te bekijken (gestart samen met de hoofdstopwatch). In dat geval mag de deelnemer de officiële stopwatch niet aanraken.
...
- 2i1c+) [VERDUIDELIJKING] Elektronische handwarmers worden beschouwd als elektronische toestellen en zijn daarom niet toegestaan tijdens het inspecteren of oplossen. Niet-elektronische handwarmers mogen echter op elk moment tijdens een poging gebruikt worden.
- 2i2+) [CLARIFICATION] De deelnemer mag overal een camera vasthouden of dragen, zolang de live beelden van de camera niet zichtbaar zijn voor de deelnemer.
...
- 3h++) [EXAMPLE] Voorbeelden van verbeteringen omvatten: nieuwe draaibewegingen zijn mogelijk, normale draaibewegingen zijn onmogelijk, meer stukken of kanten zijn zichtbaar, kleuren aan de achterkant van de puzzel zijn zichtbaar, draaibewegingen worden automatisch gedaan of de puzzels hebben meer/verschillende opgeloste toestanden.
...
- 3l++) [VERDUIDELIJKING] In het verleden waren puzzels met logo's toegestaan voor geblinddoekte wedstrijdonderdelen. Dergelijke puzzels zijn niet langer toegestaan.
...
- 4f++) [HERINNERING] Als de WCA Delegate extra scramble-reeksen genereert tijdens de wedstrijd, moeten de scramble-reeksen worden opgeslagen.
- 4g1b+) [VERDUIDELIJKING] Voor 5x5x5 Geblinddoekt moeten verkeerde puzzeltoestanden altijd gecorrigeerd worden.
- 4g1b++) [AANBEVELING] De WCA Delegate dient strenger te beoordelen of verkeerde puzzeltoestanden voor 5x5x5 kubussen al dan niet gecorrigeerd moeten worden.


## <article-5><puzzle-defects><puzzledefects> Artikel 5: Puzzeldefecten

- 5b+) [AANVULLING] De deelnemer mag niet opzettelijk een puzzeldefect veroorzaken, tenzij hij/zij een eerder puzzeldefect corrigeert (zie [Reglement 5b3b](regulations:regulation:5b3b) en [Reglement 5b3c](regulations:regulation:5b3c)). Voorbeelden van opzettelijk veroorzaakte puzzeldefecten: het verwijderen van een vastgehecht middenkapje, het draaien van een hoekstukje of het verwijderen van een sticker.
...
- 5b5f+) [VOORBEELD] Er is een [Visuale gids](https://drive.google.com/file/d/15XszaCGNvy3Dk6X6qERzZWZaDH1RH04z/view) beschikbaar voor [Reglement 5b5f](regulations:regulation:5b5f).
- 5b5f++) [VOORBEELD] Een rand “wing” van een 4x4x4 kubus die op zijn plaats gedraaid is, wordt als opgelost beschouwd.
...
- 9b+) [AANVULLING] Voor een wedstrijdonderdeel met meerdere rondes dient elke ronde na de eerste ronde (vooral de finaleronde) "Average of 5" of "Mean of 3" te zijn als één ervan een geldig format is.
...
- 9f5+) [VERDUIDELIJKING] Het resultaat van een poging is DNF als de deelnemer in aanmerking kwam voor de poging en niet starttis gestart (zie [Reglement A3b2](regulations:regulation:A3b2)). Als de deelnemer niet in aanmerking kwam voor een poging (bijvoorbeeld in een cutoff-ronde), heeft hij/zij geen resultaat voor de poging.
...
- 9t++) [AANVULLING] Als de verandering van de resultaten gebeurt tijdens de wedstrijd, moet deze regel ook worden toegepast. In dit geval dienen [9t1](regulations:regulation:9t1), [9t2](regulations:regulation:9t2) en [9t3](regulations:regulation:9t3) ook te worden gevolgd, ter beoordeling van WCA Delegate.
- 9t3+) [VOORBEELD] Stel dat deelnemer A een average van 10,00 haalt en deelnemer B een average van 10,05 in de eerste ronde van een wedstrijdonderdeel zodanig dat deelnemer A doorgaat naar de finaleronde maar B niet. Als er een fout bij het noteren van de scores wordt ontdekt, en deelnemer B eigenlijk een average van 9,95 haalde (en door had dienen te gaan in plaats van A), behoudt deelnemer A zijn resultaat voor de finaleronde.
...
- 9u2b+) [AANVULLING] De kalenderdatum van h et einde van de wedstrijd wordt bepaald door de lokale tijd van de locatie waar de wedstrijd plaatsvond.
...
- 11e1+) [HERINNERING] De extra poging moet worden gescrambeld met behulp van een ongewijzigde scramble-reeks, gegenereerd door een officieel scramble-programma (zie [Reglement 4f](regulations:regulation:4f), [Richtlijn 4f+](guidelines:guideline:4f+)).
...
- 11e2++) [VOORBEELD] Stel dat een deelnemer 5 regelmatig genummerde pogingen heeft en nr. 2 tot extra pogingen leidt. De deelnemer dient extra pogingen te doen totdat er een geldige extra poging is om nr. 2 te vervangen. Als er later een nieuwe poging tot extra pogingen leidt, dient de deelnemer op dezelfde manier te handelen als voor nr. 2.
...
- 12g2+) [HERINNERING] In het verleden was de straf voor het veranderen van de toestand van de pinnen tijdens de inspectie een DNF. Dit is niet langer het geval.
...
- B1+) [HERINNERING] De deelnemer moet een puzzel gebruiken zonder logo’s (zie [Reglement 3l](regulations:regulation:3l)), texturen, markeringen of andere kenmerken die soortgelijke stukken onderscheiden (zie [Reglement 3k](regulations:regulation:3k)). Dit dient een bijzondere aandacht te krijgen bij geblinddoekt oplossen.
...
- B4c+) [AANVULLING] Als de judge een zichtblokkering vergeet te plaatsen of deze zo plaatst dat het zicht van de deelnemer op de puzzel niet volledig geblokkeerd is, dient de WCA Delegate een extra poging toe te staan.
- B4c++) [AANVULLING] Als de WCA Delegate niet vermoedt dat de deelnemer opzettelijk een WCA Reglement heeft overtreden, mag de oorspronkelijke poging behouden blijven.
...
- E2b++) [AANVULLING] Een deelnemer mag meedoen aan een poging 3x3x3 Met minste draaien die al bezig is, ter beoordeling van de WCA Delegate. In dit geval is hun tijdslimiet de resterende tijd (d.w.z. zij moeten finishen wanneer andere deelnemers hun tijdslimiet van 60 minuten hebben bereikt). Uitzondering: een deelnemer mag niet deelnemen aan een poging 3x3x3 Met minste draaien als een deelnemer al klaar is met zijn/haar poging (zie [Richtlijn E2b+](guidelines:guideline:E2b+)) of als er een ander risico is dat informatie over de scramble bekend is bij de deelnemer die wil deelnemen.
- E2c+) [VERDUIDELIJKING] Hoewel de judge een standaardblad kan aanbieden aan deelnemers om oplossingen in te dienen, mag een deelnemer een oplossing op een ander stuk papier indienen. (Merk op dat het blad papier van de judge moet komen overeenkomstig [Reglement E3a](regulations:regulation:E3a).)
- E2c1+) [UITLEG] Een wedstrijdregistratie-ID is een identificatie (bijvoorbeeld een nummer) die aan een deelnemer wordt toegekend voor de wedstrijd. Sommige wedstrijden gebruiken dit om scorebriefjes bij te houden en resultaten in te voeren.
- E2c1++) [TOEVOEGING] Als de deelnemer vergat om informatie om de poging te identificeren op zijn oplossingsblad te schrijven, mag hij/zij die na de tijdslimiet alsnog toevoegen in het bijzijn van een judge. In dit geval moet de deelnemer het vragen aan de judge terwijl hij/zij zijn/haar oplossing indient en onmiddellijk de informatie om de poging te identificeren opschrijven (zonder andere wijzigingen aan te brengen) onder direct toezicht van de judge. Zodra een deelnemer klaar is met het indienen van zijn/haar oplossing (bijvoorbeeld door het in de handen van de judge te leggen en de judge door te laten gaan naar de volgende deelnemer, of het op de tafel van de judge te leggen en weg te lopen), mag hij/zij geen informatie meer toevoegen. Als de deelnemer iets opschrijft na de tijdslimiet maar voordat hij/zij het aan de jury vraagt, blijft de poging gediskwalificeerd (DNF).
...
- E2c1++++) [AANVULLING] Als een judge een ingediende oplossing vindt zonder informatie om de poging te identificeren (bijvoorbeeld terwijl hij/zij de poging beoordeelt), dient hij/zij naar de deelnemer die de oplossing geschreven heeft te gaan om hem/haar een DNF (in plaats van een DNS) toe te kennen. Merk op dat de deelnemer op dit moment geen informatie mag opschrijven om de poging te identificeren en aldus een DNF resultaat zal krijgen.
...
- E2c4+) [VERDUIDELIJKING] Voorbeelden van symbolen of combinaties van symbolen die niet zijn toegestaan in oplossingen voor 3x3x3 Met minste draaien: M, e, r, Y (hoofdletter), T, U1, Ui, U3, U-, R++, R2', R'2, L'w, 1R, 2U, 2f, 2-3r, 1Rw, 3Rw, 2-3Rw, rw, Rr, *, →, ⮐, /, ., ?, [r], [r u], [F], , [f]', [f]2, [x], (x), (L), 2(Rw), (U)2, (U)', (R U)', (R U R'), [R, U], [R: U].
...
- F1+) [HERINNERING] Vroeger moest de deelnemer de puzzel staand op de mat zetten. Dit is niet meer vereist.
