...
- 1c) De WCA Delegate is er verantwoordelijk voor dat de wedstrijd voldoet aan de WCA Reglementen en alle van toepassing zijnde WCA beleidslijnen of vereisten. De WCA Delegate kan specifieke eigen verantwoordelijkheden delegeren aan andere leden van het organisatieteam maar is uiteindelijk verantwoordelijk voor de manier waarop deze verantwoordelijkheden worden uitgevoerd.
    - 1c1) De WCA Delegate moet garanderen dat de wedstrijd voldoet aan de [WCA Scramble Accountability Policy](https://documents.worldcubeassociation.org/documents/policies/external/Scramble%20Accountability.pdf).
...
- 1h) Deelnemers in dezelfde ronde van een wedstrijdonderdeel kunnen als één groep deelnemen of in verschillende groepen worden verdeeld.
    - 1h1) Scramblers en judges voor een ronde mogen niet scramblen/jureren voor deelnemers in hun eigen groep voordat zij al hun eigen pogingen hebben gedaan voor de ronde. Ze mogen scramblen/jureren in hun eigen groep, ter beoordeling van de WCA Delegate maar het organisatieteam moet ervoor zorgen dat scramblers en judges geen scramble-reeksen kunnen zien voor de pogingen die zij nog moeten uitvoeren (zie [Reglement 4b2](regulations:regulation:4b2)).
...
- 2e) Deelnemers moeten een land vertegenwoordigen waarvan zij staatsburger zijn. De WCA Delegate dient de nationaliteit te verifiëren door middel van documenten (bijvoorbeeld een paspoort) bij hun eerste wedstrijd. Als een deelnemer niet in aanmerking komt om het land te vertegenwoordigen waaronder hij/zij zich heeft geregistreerd, kan de deelnemer met terugwerkende kracht worden gediskwalificeerd en/of worden geschorst, ter beoordeling van de WCA Board.
    ...
    - 2e2) Deelnemers kunnen hun land dat zij vertegenwoordigen wijzigen vóór of tijdens hun eerste wedstrijd van een kalenderjaar.
        - 2e2a) Uitzondering: Als de deelnemer de nationaliteit verliest van het land dat hij/zij eerder vertegenwoordigde, moet hij/zij het land van vertegenwoordiging vóór of tijdens zijn/haar volgende wedstrijd wijzigen (zie [Reglement 2c2](regulations:regulation:2c2)).
        - 2e2b) Uitzondering: Als de deelnemer binnen het kalenderjaar een nieuwe nationaliteit heeft verworven, mag hij/zij op elk moment tussen competities zijn/haar land van vertegenwoordiging veranderen naar zijn/haar nieuwe nationaliteit.
...
- 2g) Deelnemers moeten stil zijn wanneer ze zich binnen het aangewezen wedstrijdgebied bevinden. Praten is toegestaan maar moet op een redelijk niveau worden gehouden en niet in de buurt van deelnemers die nog actief deelnemen.
    - 2g3) Deelnemers in een lopende ronde mogen niet met elkaar communiceren over de gescramblede toestanden van de groep, tenzij al deze deelnemers niet meer in aanmerking komen voor verdere pogingen in de groep. Straf: diskwalificatie van de deelnemer(s) voor het wedstrijdonderdeel, ter beoordeling van de WCA Delegate. Uitzondering: Voor 3x3x3 Met minste draaien mogen deelnemers die hun poging hebben voltooid de scramble-reeks delen met iedereen die niet actief deelneemt aan de betreffende poging.
- 2h) Deelnemers moeten gepaste kleding dragen op de wedstrijdlocatie. Ter beoordeling van de WCA Delegate mogen deelnemers worden gediskwalificeerd wegens ongepaste kleding.
- 2i) Tijdens het inspecteren of oplossen mogen deelnemers geen gebruik maken van elektronica of audioapparatuur (bijvoorbeeld mobiele telefoons, mp3-spelers, dictafoons, extra verlichting), met uitzondering van de Stackmat-timer of de stopwatch. Straf: diskwalificatie van de poging (DNF).
...
- 2j)  De WCA Delegate kan een deelnemer diskwalificeren voor specifieke pogingen en/of wedstrijdonderdeel.
    - 2j1) Als een deelnemer om welke reden dan ook wordt gediskwalificeerd voor een wedstrijdonderdeel, komt hij/zij niet meer in aanmerking voor nog meer pogingen in het wedstrijdonderdeel.
        - 2j1a) Als de deelnemer al minstens één poging in een ronde is gestart voordat hij/zij ervoor werd gediskwalificeerd, worden de resultaten van alle resterende pogingen in het wedstrijdonderdeel geregistreerd als DNF. Als de deelnemer geen pogingen heeft gestart (d.w.z. geen resultaten heeft of alleen DNS-resultaten heeft), worden er geen resultaten geregistreerd.
...
- 3l) Een puzzel kan een logo op een gekleurd onderdeel hebben. Als dit het geval is, mag maximaal één gekleurd onderdeel een logo of meerdere logo’s dragen. Uitzondering: Voor geblinddoekte wedstrijdonderdelen mag een puzzel geen logo’s hebben.
...
- 4d) Scramble-oriëntatie:
    - 4d1) NxNxN Kubussen en Megaminx worden gescrambeld door te beginnen met het witte vlak (indien niet mogelijk, dan het lichtste vlak) bovenaan en het groene vlak (indien niet mogelijk, dan het donkerste aangrenzende vlak) vooraan.
...
- 4f) Scramble-reeksen voor wedstrijden moeten worden gegenereerd met behulp van een actuele officiële versie van een officieel WCA scramble-programma (beschikbaar [via de WCA website](https://www.worldcubeassociation.org/regulations/scrambles/)).
...
- 5b) Als er tijdens een poging een puzzeldefect optreedt, kan de deelnemer ervoor kiezen om het defect te herstellen en de poging voort te zetten, of om de poging te stoppen.
    ...
    - 5b3) Toegestane herstelacties:
        ...
        - 5b3c) Als de puzzel onoplosbaar is en oplosbaar kan worden gemaakt door één enkel hoekstukje te draaien, mag de deelnemer het hoekstukje corrigeren door het op zijn plaats te verdraaien zonder de puzzel te demonteren.
...
- 7h) Het wedstrijdgebied dient één of meerdere wachtruimtes voor deelnemers te hebben.
    - 7h1) Het organisatieteam kan eisen dat een deelnemer die is opgeroepen om deel te nemen binnen de wachtruimte voor deelnemers moet blijven totdat de deelnemer alle pogingen voor de ronde heeft voltooid.
...
- 9b) De officiële wedstrijdonderdelen van de WCA zijn:
    ...
    - 9b5) 3x3x3 Meervoudig geblinddoekt.
        ...
        - 9b5b) Cutoff-formats voor dit wedstrijdonderdeel: "Best of X" (X is 1for 2) cutoff-fase voor "Best of Y" (Y is 2 of 3, en Y > X).
- 9f) De resultaten van een ronde worden als volgt gemeten:
    ...
    - 9f2) Alle getimede resultaten en gemiddelden boven de 10 minuten, alsook alle tijden voor 3x3x3 Meervoudig geblinddoekt resultaten, worden gemeten en afgerond naar de dichtstbijzijnde seconde (bijvoorbeeld X.49 wordt X, X.50 wordt X+1).
    - 9f4) Het resultaat van een poging wordt geregistreerd als DNF (Did Not Finish) als de poging is gediskwalificeerd of onopgelost/onvoltooid.
        - 9f4a) Als een deelnemer een reglement zo overduidelijk overtreedt dat de poging zeker gediskwalificeerd zal worden, dient het jurylid de poging onmiddellijk te staken. Als het jurylid onzeker is of een geschil storend zou kunnen zijn (bijvoorbeeld omdat een extra poging de wedstrijd zou kunnen vertragen), dient het jurylid de WCA Delegate te raadplegen.
...
- 10e) Een puzzel is opgelost als alle gekleurde onderdelen zijn opgelost en alle delen correct zijn uitgelijnd binnen de onderstaande limieten:
    ...
    - 10e3) Als één draaibeweging nodig is, wordt de puzzel beschouwd als opgelost met een tijdstraf (+2 seconden).
    - 10e4) Als meer dan één draaibeweging nodig is, wordt de puzzel beschouwd als onopgelost (DNF).
...
- 11e) De WCA Delegate kan een extra poging aan een deelnemer toekennen ter vervanging van de poging die door het incident werd verstoord. Om in aanmerking te komen voor een extra poging dient de deelnemer op het moment van het incident mondeling of schriftelijk bij de judge en de WCA Delegate in beroep te gaan voordat de oorspronkelijke poging is voltooid. In beroep gaan is geen garantie voor een extra poging.
    - 11e1) een deelnemer een extra poging krijgt, dient er voor deze extra poging een andere scramble-reeks gebruikt te worden. Deze scramble-reeks moet worden gegenereerd met behulp van een huidige officiële versie van een officieel WCA scramble-programma (zie [Reglement 4f](regulations:regulation:4f)).
...
- A2) Scrambling:
    - A2a) Wanneer een deelnemer wordt opgeroepen voor een ronde, dient de deelnemer de puzzel in opgeloste vorm in te leveren bij de scrambler. De deelnemer wacht dan in de wachtruimte voor deelnemers tot hij/zij wordt geroepen om deel te nemen.
    ...
    - A2d) Bij het overnemen van een puzzel van de scrambler inspecteert de judge kort de puzzel om te zien of de puzzel grondig gescrambled is. De judge meldt elke twijfel bij de scrambler die vervolgens een gedetailleerde controle uitvoert.
        - A2d1) De scrambler of een bevoegde judge moet de gescramblede puzzel controleren en het scoreformulier ondertekenen (of paraferen) om te bevestigen dat ze de correct genummerde scramble-reeks hebben toegepast en hebben gecontroleerd of deze overeenkomt met de afbeelding (zie [Reglement 4g](regulations:regulation:4g)). Uitzondering: voor 6x6x6 Kubus, 7x7x7 Kubus en Megaminx mag de scrambler tekenen (of paraferen) om te bevestigen dat de puzzel voldoende gescrambled is (zie [Reglement 4g1](regulations:regulation:4g1)).
...
- A3) Inspectie:
    ...
    - A3c) De deelnemer mag de puzzel tijdens de inspectie oppakken.
        ...
        - A3c4) Voor Square-1, als het gebruik van een dun voorwerp in de puzzel is opgelegd door het organisatieteam (zie [Reglement A2b1](regulations:regulation:A2b1)), mag de deelnemer het voorwerp tijdens de inspectie uit de puzzel verwijderen.
...
- A6) Stoppen met oplossen:
    ...
    - A6b) De deelnemer is verantwoordelijk voor het correct stoppen van de Stackmat-timer.
        ...
        - A6b2) Als de timer stopt vóór het einde van de oplossing en een tijd van 0,06 seconden of meer aangeeft, wordt de poging gediskwalificeerd (DNF). Uitzondering: als de deelnemer kan aantonen dat de timer niet goed heeft gewerkt, kan een extra poging toegewezen worden, ter beoordeling van de WCA Delegate.
...
- A7) Vastleggen van het resultaat:
    ...
    - A7b) De deelnemer controleert het geregistreerde resultaat en ondertekent (of parafeert) het scorebriefje om te bevestigen dat het resultaat correct, volledig, correct geformatteerd en duidelijk leesbaar is. Hiermee is de poging voltooid.
        ...
        - A7c5) Ontbrekende handtekeningen die gevonden worden vóór het einde van de wedstrijd (zie [Reglement 9u](regulations:regulation:9u)) mogen toegevoegd worden door de judge en/of de deelnemer, ter beoordeling van de WCA Delegate.
...
- B6) Stoppen met oplossen:
    ...
    - B5b) Als een stopwatch in gebruik is als de enige timer, stopt de deelnemer het oplossen door de puzzel los te laten en de judge te melden klaar te zijn met het oplossen. De judge stopt de stopwatch zodra de deelnemer dit doet.
        - B5b1) Het standaard meldingssignaal van de deelnemer bestaat uit het loslaten van de puzzel(s) uit de handen en het plaatsen van de handen op het oppervlak, met de handpalmen naar beneden. De deelnemer en de judge mogen voor de start van de poging een andere geschikte melding afspreken.
...
- E2) Procedure voor 3x3x3 Met minste draaien:
    ...
    - E2c) Na 60 minuten moet elke deelnemer aan de jury één blad papier overhandigen met een geschreven oplossing en informatie om de poging te identificeren.
        - E2c1) Informatie om de poging te identificeren is: de naam van de deelnemer, WCA ID of wedstrijdregistratie-ID (min. één, meerdere optioneel), en optioneel de naam van de wedstrijd, de ronde, of het nummer van de poging. Straf voor het indienen van een oplossing zonder naam, WCA ID of wedstrijdregistratie-ID: diskwalificatie van de poging (DNF).
        - E2c2) De oplossing moet een enkele ondubbelzinnige reeks draaibewegingen zijn met elke afzonderlijke draaibeweging uitgeschreven in opeenvolgende volgorde. Straf voor een onduidelijke oplossing: diskwalificatie van de poging (DNF).
        - E2c3) De deelnemer dient alle draaibewegingen op het papier die geen deel uitmaken van de beoogde oplossing duidelijk zwart te maken/te doorstrepen.
        - E2c4) De oplossing van de deelnemer mag alleen draaibewegingen gebruiken die exact gedefinieerd zijn als notatie voor de 3x3x3 Kubus in [Reglement 12a](regulations:regulation:12a) en mag geen symbolen of combinaties van symbolen gebruiken die daar niet specifiek gedefinieerd zijn. Straf: diskwalificatie van de poging (DNF).
        - E2c5) De oplossing van de deelnemer wordt als correct beschouwd als een bij aanvang opgeloste puzzel na het toepassen van de scramble-reeks en de oplossing resulteert in een opgeloste puzzel. Straf voor een onjuiste oplossing: diskwalificatie van de poging (DNF).
...
## <article-F><clock><clocksolving> Artikel F: Oplossen van de Clock

- F1) Standaard speedsolving procedures worden gevolgd, zoals beschreven in [Artikel A](regulations:article:A) (Speed Solving). Aanvullende reglementen die de overeenkomstige procedures in [Artikel A](regulations:article:A) vervangen worden hieronder beschreven.
- F2) Het organisatieteam mag het gebruik van een standaard voor de puzzel afdwingen om te voorkomen dat de puzzel valt vóór de start van de poging. Als een dergelijke standaard wordt gebruikt, dient het organisatieteam dit aan te kondigen vóór het begin van de ronde.
- F3) De deelnemer mag de posities van de pinnen veranderen tijdens de inspectie. Deze wijzigingen worden niet geteld als draaibewegingen.
- F4) De deelnemer mag de toestand van de binnenste wijzerplaten van de puzzel niet veranderen tijdens de inspectie. Straf: diskwalificatie van de poging (DNF).
...
- H1) Standaard geblinddoekt speedsolving procedures worden gevolgd, zoals beschreven in [Artikel B](regulations:article:B) (Blindfolded Solving). Aanvullende reglementen die de overeenkomstige procedures in [Artikel B](regulations:article:B) vervangen worden hieronder beschreven.
    - H1a) Vóór een poging moet de deelnemer het aantal puzzels (min. 2) die hij/zij wil proberen bij het organisatieteam inleveren.
        ...
        - H1a3) Vóór de poging moeten de gescramblede puzzels op een willekeurige manier op de tafel worden geplaatst, terwijl ervoor gezorgd wordt dat ze volledig bedekt blijven. De puzzels dienen in een zo vierkant mogelijke vorm te worden geplaatst (bijvoorbeeld 8 puzzels dienen in 2 rijen van 3 puzzels en 1 rij van 2 puzzels te worden gerangschikt).
