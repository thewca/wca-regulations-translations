...
- <label>[ECLAIRCISSEMENT] Information dont le but est lever les doutes lors de l'interprétation du Règlement.
...
- 1c3+) [CONSEIL] Les résultats devraient être prêt à être publier à la fin du dernier jour de compétition.
- 1c3++) [AJOUT] Les archives physiques (telles que les feuilles de résultats ou les solutions de résolution optimisée) doivent être gardées pendant une durée minimale d'un mois. Les archives numériques (tels que les mélanges ou les résultats) doivent être gardées à vie.
- 1c3b+) [ECLAIRCISSEMENT] S'il y a plusieurs groupes, il n'y a pas besoin de savoir quel compétiteur était dans quel groupe.
- 1c4+) [CONSEIL] Les corrections à apporter aux résultats devrait être faites dans la semaine suivant la date de la compétition.
- 1c10+) [ECLAIRCISSEMENT] Il est suffisant d'assurer l'accès à une copie numérique du Règlement.
- 1h+) [CONSEIL] Les compétiteurs d'un seul et même groupe devraient résoudre les même séquences de mélange. Des groupes différents devraient utiliser des séquences de mélange différentes.
- 1h++) [CONSEIL] Tous les tours finaux d'une épreuve, ainsi que tous les tours de résolution optimisée, devrait avoir les même mélanges pour tous les compétiteurs (c'est-à-dire un seul groupe).
...
- 2h+) [ECLAIRCISSEMENT] Les compétiteurs peuvent être pieds nu pour la résolution avec les pieds.
...
- 3a+) [ECLAIRCISSEMENT] Les compétiteurs peuvent utiliser des casse-tête de n'importe quelle taille pourvue qu'elle soit raisonable, à la discrétion du Délégué WCA.
...
- 3a1+) [ECLAIRCISSEMENT] Les compétiteurs peuvent être disqualifiés s'ils ne peuvent pas se présenter au moment où ils sont appelés, ou s'ils n'ont pas de casse-tête à confier (par exemple s'ils avaient prévu d'utiliser le casse-tête d'un compétiteur entrain de concourir).
- 3d+) [RAPPEL] Avant les casse-tête imprimés ou peints étaient autorisés à la place des étiquettes ou tuiles. Ce n'est plus le cas.
...
- 4d+) [ECLAIRCISSEMENT] Certains casse-tête utilisent des schémas de couleurs standard, ormis le blanc qui est remplacé du noir. Dans ce cas, la couleur la plus sombre est le noir et ne dois pas être considéré comme du blanc.
- 4f+) [CONSEIL] Le Délégué WCA devrait générer un nombre suffisant de mélange pour la totalité de la compétition, avec également des mélanges pour les essais supplémentaires.
