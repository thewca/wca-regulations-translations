...
- 9g) 複合ラウンドは「Best of X」のカットオフ段階とカットオフ基準を持つラウンドである（例：カットオフ基準が 2 分の「Best of 2」。）競技者がカットオフ段階の試技のうち少なくとも 1 つでカットオフ基準を満たした場合、残りの試技を行うことができる。カットオフ段階の試技はラウンド全体の試技に含まれる。
